        ...
        <div id="fullpage">
            ...
            <section class="faq js-section" style="background-image: url('https://www.hyundai.ru/assets/img/startplus/pics/bgr_3.jpg')">
                ...
                <div class="faq__dsclmr">
                    <a href="https://www.hyundai.ru/ContactUs" target="_blank" class="faq__button delay8">
                        <div class="faq__icon">
                    ...
                    <path class="st0" d="M21,19.5c-1.4,0-2.6,1.1-2.6,2.5c0,1.4,1.1,2.6,2.5,2.6c1.4,0,2.6-1.1,2.6-2.5l0,0C23.5,20.6,22.4,19.5,21,19.5
                        ...
                        L12.1,19.5z"></path>
                                <path class="st0" d="M29.9,19.5c-1.4,0-2.6,1.1-2.6,2.5s1.1,2.6,2.5,2.6s2.6-1.1,2.6-2.5v0C32.4,20.6,31.3,19.5,29.9,19.5z"></path>
                        ...
                        c8,6.1,9.4,17.5,3.2,25.3C34.2,33.3,32.7,34.7,31,35.8z"></path>
                    </svg>
                        </div>
                    ...
                    <p>
                        Santa Fe – 17 990 месяц

                        Santa Fe - Общий ежемесячный платеж по программе «СТАРТ ПЛЮС» от 17 990 рублей в месяц. Платеж состоит из платежа по кредиту в 12 000 рублей** и платежа по программе страхования КАСКО и Сервис в размере 5 990 рублей***.
