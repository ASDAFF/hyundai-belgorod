...
?>
    ...
    <link rel="stylesheet" type="text/css" href="/media/css_new/pip_flat_i40.css"/>
    ...
    <script type="text/javascript" src="/media/js_new/pip_flat_i40.js"></script>
    <!-- <script type="text/javascript" src="/media/js_new/pip_flat_SL_com_jspPane.js"></script> -->

    <style>
        /* parallax bg */
        .parallax0 {background:url('/media/images/flat/i40/elements/parallax_1.jpg') no-repeat fixed 50% 50% #fff;}/* dec 29 15 */
        .parallax1 {background:url('/media/images/flat/i40/elements/parallax_2.jpg') no-repeat fixed 50% 50% #fff;}/* 2015-07-31 */
        .parallax2 {background:url('/media/images/flat/i40/elements/parallax_3.jpg') no-repeat fixed 50% 50% #fff;}
        .parallax3 {background:url('/media/images/flat/i40/elements/parallax_4.jpg') no-repeat fixed 50% 50% #fff;}
        .parallax4 {background:url('/media/images/flat/i40/elements/parallax_5.jpg') no-repeat fixed 50% 50% #fff;}
        .parallax5 {background:url('/media/images/flat/i40/elements/parallax_6.jpg') no-repeat fixed 50% 50% #fff;}

        body.mobile .parallax { height:450px;}
        body.mobile .parallax1 {background:url('/media/images/flat/i40/elements/parallax_1.jpg') center top no-repeat #e3e3e3;}/* dec 29 15 */
        body.mobile .parallax1 {background:url('/media/images/flat/i40/elements/parallax_2.jpg') center top no-repeat #e3e3e3;}/* 2015-07-31 */
        body.mobile .parallax2 {background:url('/media/images/flat/i40/elements/parallax_3.jpg') center top no-repeat #fff;}
        body.mobile .parallax3 {background:url('/media/images/flat/i40/elements/parallax_4.jpg') center top no-repeat #fff;}
        body.mobile .parallax4 {background:url('/media/images/flat/i40/elements/parallax_5.jpg') center top no-repeat #fff;}
        body.mobile .parallax5 {background:url('/media/images/flat/i40/elements/parallax_6.jpg') center top no-repeat #fff;}
    </style>
    ...
    <div class="wrap" id="wrap">
        ...
        i40 LANDING; BASED ON SOLARIS REDESIGN TEMPLATE
        ...
        <div class="gallery-view-wrap">
            <div class="gallery-view-holder">
                ...
                <div class="topline">
                    <img src="/media/images/flat/i40/elements/logo-wht-s.png">
                    ...
                    <div class="items">
                        <div class="item">
                            <div class="item_wrap">
                                <div class="main mkv">
                                    <div class="title">
                                        <img src="/media/images/flat/i40/elements/logo.png" title="i40" alt="Эмблема i40">
                                        <span>Бизнес-класс — и точка!</span>
                                    </div>
                                ...
                                <!-- 						<img src="/media/images/flat/i40/elements/info_car_pic.png" style="float: right; margin-top: 100px;"> -->
                                <div class="view-360_wrap">
                                    ...
                                    <div class="spritespin" data-model="i40"></div>
                                </div>
                                <div class="view-360-color-selector">
                                    <ul>
                                        ...
                                        <li data-title="Red Merlot"		data-color="Red_Merlot" class="view-360-color-selector__item"><span style="background-color: #6E0E10;"></span>Red Merlot</li>
                                        ...
                                        <li data-title="Titanium Silver"data-color="Titanum_Silver" class="view-360-color-selector__item"><span style="background-color: #6A6B66;"></span>Titanium Silver</li>
                                        <li data-title="Chalk Beige"	data-color="Chalk_Beige" class="view-360-color-selector__item"><span style="background-color: #E8DFBE;"></span>Chalk Beige</li>
                                        <!-- new -->
                                        <li data-title="Blue Spirit"	data-color="Blue_Spirit" class="view-360-color-selector__item"><span style="background-color: #87CEFA;"></span>Blue Spirit</li>
                                        <li data-title="Stone Gray"	data-color="Stone_Gray" class="view-360-color-selector__item"><span style="background-color: #1B2324;"></span>Stone Gray</li>
                                    </ul>
                                </div>
            ...
            <div id="top-menu" class="top-menu">
                <div class="top-menu__wrap">
                    <div class="information">
					 ...
					 --><li><a class="configurator" href="/configurator/?car_id=21" title="Цены комплектации">ЦЕНЫ И КОМПЛЕКТАЦИИ</a></li><!--
					 --><li class="broshure-item" title="Брошюра"><a data-gtm-havas-model="i40" href="#" data-model="i40" for="brochures_request" class="zing_form_toggler broshure" target="_blank">БРОШЮРА</a></li><!--
					 -->
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="text_play_wrap">
                            <div class="text_play">
                                ...
                                <div class="text2">Больше динамики и комфорта для тех, кто не боится <br>
                                    перемен. Все, что Вы ждете от автомобиля <br>
                                    бизнесс-класса, воплощено в новом HYUNDAI I40.
                                </div>
                            </div>
                                    ...
                                    <div class="list">
                                        <ul>
                                            <li class="thumb1 front">
                                                <a href="#">
											<span class="img_wrap">
												<img src="/media/images/flat/i40/elements/highlights_1.jpg" data-url="/media/images/flat/i40/elements/highlights_1.jpg" alt="Европейский стиль" width="306" height="306" />
                                            ...
                                            <li class="thumb2 side">
                                                <a href="#">
											<span class="img_wrap">
												<img src="/media/images/flat/i40/elements/highlights_2.jpg" data-url="/media/images/flat/i40/elements/highlights_2.jpg" alt="Безопасный" width="306" height="306" />
												<span class="dimd"></span>
											</span>
                                            ...
                                            <li class="thumb3 safe">
                                                <a href="#">
											<span class="img_wrap">
												<img src="/media/images/flat/i40/elements/highlights_3.jpg" data-url="/media/images/flat/i40/elements/highlights_3.jpg" alt="Комфортный" width="306" height="306" />
												<span class="dimd"></span>
											</span>
                                    ...
                                    <div class="view">
                                        <ul>
                                            <li class="thumb1 front">
                                                ...
                                                <div class="img"><img src="/media/images/flat/i40/elements/highlights_popup_1.jpg" data-url="/media/images/flat/i40/elements/highlights_popup_1.jpg" width="623" height="306" alt="Европейский стиль"></div>
                                                <div class="txt-wrap">
                                                    <div class="txt">
                                                        <strong>Европейский стиль</strong>
                                                        Изысканный и утонченный<br>
                                                        седан i40 выдержан в лучших <br>
                                            ...
                                            <li class="thumb2 side">
                                                <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                <div class="img"><img src="/media/images/flat/i40/elements/highlights_popup_2.jpg" data-url="/media/images/flat/i40/elements/highlights_popup_3.jpg" width="623" height="306" alt="Безопасный"></div>
                                                <div class="txt-wrap">
                                                    <div class="txt">
                                            ...
                                            <li class="thumb3 safe">
                                                <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                <div class="img"><img src="/media/images/flat/i40/elements/highlights_popup_3.jpg" data-url="/media/images/flat/i40/elements/highlights_popup_3.jpg" width="623" height="306" alt="Комфортный"></div>
                                                <div class="txt-wrap">
                                                    <div class="txt">
                                                        <strong>Комфортный</strong>
                                                        Интерьер создавался<br>
                                                        с использованием лучших <br>
                                                        электрических компонентов <br>
                                ...
                                <div class="left">
                                    <div class="subject">
                                        ...
                                        <p>
                                            ...
                                            двигатели для седана i40<br>
                                            обеспечивают высокую<br>
                                            экономичность.
                                        </p>
                                    </div>
                                    <div class="image">
                                        <img src="/media/images/flat/i40/elements/highlights_4.jpg" width="" height="" alt="Экономичный расход топлива" />
                                    </div>
                                </div>
                                <div class="mid">
                                    <div class="subject">
                                        ...
                                        <p>
                                            ...
                                            отделение объемом 505 литров<br>
                                            позволит вместить абсолютно все!
                                        </p>
                                    </div>
                                    <div class="image">
                                        <img src="/media/images/flat/i40/elements/highlights_5.jpg" width="" height="" alt="Максимальный простор" />
                                    </div>
                                </div>
                                <div class="right">
                                    <div class="subject">
                                    ...
                                    <div class="image">
                                        <img src="/media/images/flat/i40/elements/highlights_6.jpg" width="" height="" alt="6-ступенчатая коробка передач" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pos">
                                <ul class="view">
                                    <li class="front">
                                        <div class="scene">
                                            <div class="car">
                                                <img src="/media/images/flat/i40/elements/angle_1.png" alt="Фото экстерьера i40" />
                                                <div class="plus_wrap">
                                                    <div class="plus plus1 left"><a href="#"><span>more</span></a><span class="txt"><span>Решетка радиатора</span></span></div>
                                                    <div class="plus plus2 left"><a href="#"><span>more</span></a><span class="txt"><span>Ксеноновые фары</span></span></div>
                                                    <div class="plus plus3 left"><a href="#"><span>more</span></a><span class="txt"><span>Светодиодные передние противотуманные фары</span></span></div>
                                                </div>
                                            </div>
                                            <div class="sub_wrap">
                                                <ul>
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/i40/elements/exterior_popup_1.jpg" width="470" height="470" alt="Решетка радиатора" /></div>
                                                        <div class="txt">
                                                    ...
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/i40/elements/exterior_popup_2.jpg" width="470" height="470" alt="Ксеноновые фары" /></div>
                                                        <div class="txt">
                                                    ...
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/i40/elements/exterior_popup_3.jpg" width="470" height="470" alt="Светодиодные передние противотуманные фары" /></div>
                                                        <div class="txt">
                                    ...
                                    <li class="side">
                                        <div class="scene">
                                            <div class="car">
                                                <img src="/media/images/flat/i40/elements/angle_2.png" alt="Вид сбоку i40" />
                                                <div class="plus_wrap">
                                                    <div class="plus plus1 left"><a href="#"><span>more</span></a><span class="txt"><span>Светодиодный повторитель указателей поворота</span></span></div>
                                            ...
                                            <div class="sub_wrap">
                                                <ul>
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/i40/elements/exterior_popup_4.jpg" width="470" height="470" alt="Светодиодный повторитель указателей поворота" /></div>
                                                        <div class="txt">
                                    ...
                                    <li class="rear">
                                        <div class="scene">
                                            <div class="car">
                                                <img src="/media/images/flat/i40/elements/angle_3.png" alt="Вид багажника i40" />
                                                <div class="plus_wrap">
                                            ...
                                            <div class="sub_wrap">
                                                <ul>
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/i40/elements/exterior_popup_6.jpg" width="470" height="470" alt="Светодиодные фонари" /></div>
                                                        <div class="txt">
                                                            <strong>Светодиодные фонари</strong>
                                                            Широкие задние фонари изящной формы
                                                            плавно повторяют обводы кузова.
                                                            Использование светодиодов вместо
                                                            обычных ламп повышает безопасность
                                                            благодаря повышенной яркости и более
                                                            быстрому включению.
                                                        </div>
                                                    </li>
                                                </ul>
                    ...
                    <div class="pip_cont">
                        <div class="text_play_wrap">
                            <div class="text_play">
                                ...
                                <div class="text1">Спортивный и<br>высокотехнологичный<br>образ изнутри и снаружи
                                </div>
                                <div class="text2">
                            ...
                            <div class="scene_wrap">
                                <div class="scene_offset">
                                    <div class="offset2">
                                        <div class="scene_cut">
                                            <div class="scene1">
                                                <div class="img">
                                                    <img src="/media/images/flat/i40/elements/view_1.jpg" width="1050" height="540" alt="Фото интерьера салона i40" />
                                                    <div class="plus_wrap">
                                            ...
                                            <div class="scene2">
                                                <div class="img">
                                                    <img src="/media/images/flat/i40/elements/view_2.jpg" width="1050" height="540" alt="Фото интерьера салона i40" />
                                                    <div class="plus_wrap">
                                ...
                                <div class="details">
                                    <div class="pop_11">
                                        ...
                                        <img src="/media/images/flat/i40/elements/interior_popup_1.jpg" width="525" height="540" alt="Многофункциональный руль" />
                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                    </div>
                                    <div class="pop_12">
                                        <div class="details_txt">
                                        ...
                                        <img src="/media/images/flat/i40/elements/interior_popup_2.jpg" width="525" height="540" alt="Климат-контроль" />
                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                    </div>
                                    <div class="pop_13">
                                        <div class="details_txt">
                                        ...
                                        <img src="/media/images/flat/i40/elements/interior_popup_3.jpg" width="525" height="540" alt="Водительское сиденье с электроприводом, встроенной памятью (IMS) и функциями управления" />
                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                    </div>
                                    <div class="pop_14">
                                        <div class="details_txt">
                                            <strong>Вместительный багажник</strong>
                                            <p>
                                                Багажник седана i40 — один из самых<br>
                                                вместительных в этом классе: его объем <br>
                                                составляет 505 л плюс 20 л для запасного колеса.
                                            </p>
                                        </div>
                                        <img src="/media/images/flat/i40/elements/interior_popup_4.jpg" width="525" height="540" alt="Вместительный багажник" />
                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                    </div>
                                </div>
                                        ...
                                        <div class="carousel-holder">
                                            <div class="carousel-slider">
                                                <div class="carousel-item morelist alive">
                                                    <ul class="clearfix">
                                                        <li>
                                                            <span class="img"><img width="306" height="200" alt="Вентиляция сидений" src="/media/images/flat/i40/elements/interior_1.jpg"/></span>
                                                            <span class="description">
                                                                <strong>Вентиляция сидений</strong>
                                                                В жаркую погоду комфорт нахождения в автомобиле подарит вентиляция передних сидений (прохладный воздух подается через микроперфорацию в кожаной обивке).
                                                            </span>
                                                        </li>

                                                        <li>
                                                            <span class="img"><img width="306" height="200" alt="Подогрев сидений" src="/media/images/flat/i40/elements/interior_2.jpg"/></span>
                                                            <span class="description">
                                                                <strong>Подогрев сидений</strong>
                                                                Передние сиденья оснащены <br>
                                                                подогревом подушки и спинки кресла <br>
                                                                с тремя температурными режимами. <br>
                                                                Задние сиденья также оснащены<br>
                                                                двухступенчатым подогревом.
                                                            </span>
                                                        </li>
                                                        <li>
                                                            <span class="img"><img width="306" height="200" alt="Крепления детского кресла ISOFIX" src="/media/images/flat/i40/elements/interior_3.jpg"/></span>
                                                            <span class="description">
                                                                <strong>Крепления детского кресла ISOFIX</strong>
                                                                Простые в использовании <br>
                                                                кронштейны ISOFIX обеспечивают<br>
                                                                безопасность крепления детского <br>
                                                                кресла.
                                                            </span>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div class="carousel-item morelist">
                                                    <ul class="clearfix">
                                                        <li>
                                                            <span class="img"><img width="306" height="200" alt="Удобный центральный подлокотник" src="/media/images/flat/i40/elements/interior_4.jpg"/></span>
                                                            <span class="description">
                                                                <strong>Удобный центральный подлокотник</strong>
                                                        ...
                                                        <li>
                                                            <span class="img"><img width="306" height="200" alt="Контейнер для хранения" src="/media/images/flat/i40/elements/interior_5.jpg"/></span>
                                                            <span class="description">
                                                                <strong>Контейнер для хранения</strong>
                                                                Удобные подстаканники легко <br>
                                                                использовать как контейнер для <br>
                                                                хранения всевозможных мелочей. <br>
                                                                Благодаря сдвигающейся крышке <br>
                                                                он будет всегда выглядеть аккуратно.
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                ...
                <div id="contents_performance" class="contents_performance pip">
                    ...
                    <div class="pip_cont">
                        <div class="text_play_wrap">
                            <div class="text_play">
                                ...
                                <div class="text1">С i40 границы<br>исчезают</div>
                        ...
                        <div class="menu">
                            <ul>
                                <li class="on"><a href="#">1.6 GDi</a></li><!-- no space
						--><li><a href="#">1.7 CRDi</a></li><!-- no space
                        ...
                        <div class="engine_list">
                            <ul>
                                <li>
                                    <div class="engine1">1.6 GDi</div>
                                    <p>
                                        Самый экономичный силовой агрегат в линейке двигателей i40 с рабочим объемом 1.6 литра и непосредственным впрыском топлива выдает максимальную мощность 135 л.с. при 6300 об/мин. Двигатель, оснащенный системой GDI, потребляет всего 6,4 л/100 км в смешаном цикле.
                                    </p>
                                    <div class="graph">
                                        <div class="pos">
                                            <img src="/media/images/flat/i40/elements/performance_graph.png" width="395" height="427" alt="График показателей двигателя 1.6 GDi" /><br>
                                            <div class="text"><img src="/media/images/flat/i40/elements/performance_graph_text.png" width="395" height="427" alt="График показателей двигателя 1.6 GDi" /></div>
                                        </div>
                                    </div>
                                    <div class="max">
                                        <dl class="max_power">
                                            <dt></dt>
                                            <dd><strong>135</strong> <span class="unit">Макс. мощность, Л.с.</span></dd>
                                        </dl>
                                        <dl class="max_toque">
                                            <dt></dt>
                                            <dd><strong>165</strong> <span class="unit">Макс. крутящий момент, Нм</span></dd>
                                        </dl>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="graph">
                                        <div class="pos">
                                            <img src="/media/images/flat/i40/elements/performance_graph_2.gif" class="lazy" width="406" height="637" alt="График показателей двигателя 1.7 CRDi" /><br>
                                            <div class="text"><img src="/media/images/flat/i40/elements/performance_graph_2_text.png" class="lazy" width="406" height="637" alt="График показателей двигателя 1.7 CRDi" /></div>
                                        </div>
                                    </div>
                                    <div class="max">
                                        <dl class="max_power">
                                ...
                                <li>
                                    ...
                                    <div class="graph">
                                        <div class="pos">
                                            <img src="/media/images/flat/i40/elements/performance_graph_3.gif" class="lazy" width="406" height="637" alt="График показателей двигателя 2.0 MPI" /><br>
                                            <div class="text"><img src="/media/images/flat/i40/elements/performance_graph_3_text.png" class="lazy" width="406" height="637" alt="График показателей двигателя 2.0 MPI" /></div>
                                        </div>
                                    </div>
                                    <div class="max">
                                        <dl class="max_power">
                                        ...
                                        <dl class="max_toque">
                                            <dt></dt>
                                            <dd><strong>193</strong> <span class="unit">Макс. крутящий момент, Нм</span></dd>
                                        </dl>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="morelist">
						...
						<span class="description">
							...
							Пришедшая на смену 5-ступенчатой 6-ступенчатая<br>
							коробка передач более компактная, легкая, плавная и тихая.<br>
							Кроме того, добавление еще одной передачи<br>
							обеспечило дополнительную экономию топлива.
						</span>
                                <div class="btm_img"><img class="lazy" width="525" height="465" alt="Автоматическая коробка переключения передач" src="/media/images/common/transparent.gif" data-original="/media/images/flat/i40/elements/performance_1.jpg" /></div>
                            </li>
                            <li>
						<span class="description">
							<strong>Механическая коробка передач</strong>
							Для приверженцев механической коробки передач Hyundai <br>
							предлагает 6-ступенчатую механическую коробку передач,<br>
							отличающуюся очень четким и тихим переключением.
						</span>
                                <div class="btm_img"><img class="lazy" width="525" height="465" alt="Механическая коробка переключения передач" src="/media/images/common/transparent.gif" data-original="/media/images/flat/i40/elements/performance_2.jpg" /></div>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="pip_cont">
                        <div class="text_play_wrap">
                            <div class="text_play">
                                ...
                                <div class="text2">В седане i40 предусмотрены всевозможные меры <br>
                        ...
                        <div class="scene_wrap">
                            <div class="scene">
                                <img class="car" src="/media/images/flat/i40/elements/safety_1.jpg" width="940" height="" title="" alt="Электронная система стабилизации (ESС)">
                            </div>
                            <div class="text_wrap">
                        ...
                        <div class="safety_slider-wrap">
                            <ul class="safety_slider">
                                <li class="safety_slider-item alive" class="alive">
                                    <img class="lazy" src="/media/images/common/transparent.gif" data-original="/media/images/flat/i40/elements/safety_slider_1.jpg" width="1920" height="540" alt="9 подушек безопасности">
							...
							серьезных травм к минимуму.
                                ...
                                <li class="safety_slider-item">
                                    <img src="/media/images/flat/i40/elements/safety_slider_2.jpg" width="1920" height="540" alt="Система помощи при торможении (BAS)">
							...
							тормозном пути.
                                ...
                                <li class="safety_slider-item">
                                    <img src="/media/images/flat/i40/elements/safety_slider_3.jpg" width="1920" height="540" alt="Система помощи при трогании на подъеме (HAC)">
							...
							для предотвращения опасного откатывания назад.
                                ...
                                <li class="safety_slider-item">
                                    <img src="/media/images/flat/i40/elements/safety_slider_4.jpg" width="1920" height="540" alt="Система управления стабилизацией (VSM)">
                            ...
                            <ul class="safety_slider-paginator">
                                <li class="alive">
                                    <img class="lazy" alt="" src="/media/images/common/transparent.gif" data-original="/media/images/flat/i40/elements/safety_preview_1.jpg" width="90" height="90">
                                    <div class="bordered"></div>
                                </li>
                                <li>
                                    <img class="lazy" alt="" src="/media/images/common/transparent.gif" data-original="/media/images/flat/i40/elements/safety_preview_2.jpg" width="90" height="90">
                                    <div class="bordered"></div>
                                </li>
                                <li>
                                    <img class="lazy" alt="" src="/media/images/common/transparent.gif" data-original="/media/images/flat/i40/elements/safety_preview_3.jpg" width="90" height="90">
                                    <!-- 							<div class="bordered-ghost"></div> -->
                                    <div class="bordered"></div>
                                </li>
                                <li>
                                    <img class="lazy" alt="" src="/media/images/common/transparent.gif" data-original="/media/images/flat/i40/elements/safety_preview_4.jpg" width="90" height="90">
                                    <div class="bordered"></div>
                                </li>
                            </ul>
                            ...
                            <ul class="list_wrap">
                                <li class="list list1">
                                    <a href="#">
                                        ...
                                        <img src="/media/images/flat/i40/elements/convenience_1.jpg" width="470" height="250" alt="Аудиосистема для меломанов" />
                                    </a>
                                </li>
                                <li class="list list2">
                                    <a href="#">
                                        <strong>Система помощи<br>при парковке</strong>
                                        <img src="/media/images/flat/i40/elements/convenience_2.jpg" width="470" height="250" alt="Система помощи при парковке" />
                                    </a>
                                </li>
                                <li class="list list3">
                                    <a href="#">
                                        <strong>Удобная <br>панель приборов</strong>
                                        <img src="/media/images/flat/i40/elements/convenience_3.jpg" width="470" height="250" alt="Удобная панель приборов" />
                                    </a>
                                </li>
                                <li class="list list4">
                                    <a href="#">
                                        <strong>Система адаптивного <br>переднего освещения (AFLS)</strong>
                                        <img src="/media/images/flat/i40/elements/convenience_4.jpg" width="470" height="250" alt="Система адаптивного переднего освещения (AFLS)" />
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="convenience__slider-cut">
                                <ul class="view_wrap">
                                    <li class="view view1 alive">
                                        <img src="/media/images/flat/i40/elements/convenience_popup_1.jpg" width="940" height="500" alt="Аудиосистема для поклонников музыки" />
                                        <div class="text">
                                    ...
                                    <li class="view view2">
                                        <img src="/media/images/flat/i40/elements/convenience_popup_2.jpg" width="940" height="500" alt="Система помощи при парковке" />
                                        <div class="text">
                                            <strong>Система помощи <br>при парковке </strong>
                                            Интеллектуальная система помощи при парковке<br>
                                            (SPAS) седана i40 находит идеальное место для<br>
                                            парковки с помощью суперточных ультразвуковых <br>
                                            датчиков и паркует автомобиль автоматически.
                                        </div>
                                    </li>
                                    <li class="view view3">
                                        <img src="/media/images/flat/i40/elements/convenience_popup_3.jpg" width="940" height="500" alt="Удобная панель приборов" />
                                        <div class="text">
                                    ...
                                    <li class="view view4">
                                        <img src="/media/images/flat/i40/elements/convenience_popup_4.jpg" width="940" height="500" alt="Система адаптивного переднего освещения (AFLS)" />
                                        <div class="text">
                                            <strong>Система адаптивного <br>переднего освещения (AFLS)</strong>
                            ...
                            <div class="carousel-holder">
                                <div class="carousel-slider">
                                    <div class="carousel-item morelist alive">
                                        <ul class="clearfix">
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Электромеханический стояночный тормоз" src="/media/images/flat/i40/elements/convenience_5.jpg"/></span>
										<span class="description">
											<strong>Электромеханический <br>стояночный тормоз</strong>
											Удобная и компактная кнопка ручного<br>
											тормоза эффективно взаимодействует<br>
											с электронной системой управления<br>
											тормозными механизмами, а так же<br>
											экономит пространство в салоне.
										</span>
                                            </li>
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Запуск двигателя кнопкой" src="/media/images/flat/i40/elements/convenience_6.jpg"/></span>
										<span class="description">
											<strong>Запуск двигателя кнопкой</strong>
											Кнопка запуска двигателя в разы<br>
											удобнее классического ключа<br>
											зажигания - достаточно носить<br>
											ключ в кармане, и вы сможете<br>
											запускать и выключать двигатель<br>
											седана i40 одним нажатием.
										</span>
                                            </li>
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Переключение передач с помощью подрулевых переключателей" src="/media/images/flat/i40/elements/convenience_7.jpg"/></span>
										<span class="description">
                                    ...
                                    <div class="carousel-item morelist">
                                        <ul class="clearfix">
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Порт USB" src="/media/images/flat/i40/elements/convenience_8.jpg"/></span>
										<span class="description">
											<strong>Порт USB</strong>
											Позволяет проигрывать аудиозаписи<br>
											с большинства аудиоплееров, а <br>
											также устройств флэш-памяти.
										</span>
                                            </li>
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Коленная подушка безопасности" src="/media/images/flat/i40/elements/convenience_9.jpg"/></span>
										<span class="description">
				                            <strong>Коленная подушка безопасности</strong>
											Эта подушка устанавливается<br>
											прямо под рулевой колонкой и <br>
											предназначена для уменьшения <br>
											риска получения серьезных травм <br>
											ног и коленей при фронтальном<br>
											столкновении.
										</span>
                                            </li>
                                        </ul>
                ...
                <div id="contents_specs" class="contents_specs pip">
                    <div class="specs_wrap">
                        <div class="title_wrap clearfix">
                            <h2 class="title_wrap_h2">Технические характеристики Hyundai i40</h2>
                    ...
                    <div class="detailedSpecLink">
                        <a href="/configurator?car_id=25&compl_id=199">Подробные характеристики</a>
                    </div>
            ...
            <div class="content-type content-type__gallery">
                <div id="contents_gallery" class="contents_gallery pip">
                    <div class="gallery_wrap">
                        <div class="title_wrap clearfix">
                            <h2 class="title_wrap_h2">Фото Hyundai i40</h2>
                        ...
                        <ul id="all-gallery-items"style="display: none;">
                            <!-- 					<li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_1.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_1.jpg"/></li> -->
                            <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_2.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_2.jpg"/></li>
                            <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_3.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_3.jpg"/></li>
                            <!-- 					<li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_4.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_4.jpg"/></li> -->
                            <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_5.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_5.jpg"/></li>
                            <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_6.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_6.jpg"/></li>
                            <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_7.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_7.jpg"/></li>
                            <!-- 					<li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_8.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_8.jpg"/></li> -->
                            <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_9.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_9.jpg"/></li>
                            <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_10.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_10.jpg"/></li>
                            <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_11.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_11.jpg"/></li>
                            <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_12.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_12.jpg"/></li>
                            <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/i40/gallery_pics/gallery_preview_13.jpg" data-href="/media/images/flat/i40/gallery_pics/gallery_13.jpg"/></li>
                        </ul>
                        <!--  -->
            ...
            <div class="prefooter-promo">
                <div class="promo-main">
                    <div class="promo-main_cont">
                        <div class="text-desc">
                            <h2 class="promo-title">Станьте владельцем<br>i40 уже сегодня</h2>
					...
					кредитования и другие предложения Drive Hyundai.
                            ...
                            <a href="/test-drive?old_car_id=21" class="btn-flat">Пройти тест-драйв</a>
                        </div>
                        <img src="/media/images/flat/i40/elements/promo_pic.png" width="667" height="290" alt="Тест драйв Hyundai i40">
                    </div>
                    <div class="promo-grid">
                        <ul class="clearfix">
                            <li><a href="/configurator/?car_id=21"><span>Конфигуратор i40</span></a></li>
                            <!-- 					<li><a href="/find-dealer"><span>Найти дилера</span></a></li> -->
                            <li><a target="_blank" href="/media/downloads/accessoires/#.pdf"><span>Каталог аксессуаров</span></a></li>
                            <li><a href="/configurator/?car_id=21"><span>Рассчитать кредит</span></a></li>
                        </ul>
                    </div>
                </div>
