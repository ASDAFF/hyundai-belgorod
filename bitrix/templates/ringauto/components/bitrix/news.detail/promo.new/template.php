		...
		<div class="container-big">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav right">
					<li class="street">
						<a href="#contact" class="street">
							Воронеж, ул. Изыскателей 39 +7 (473) 261-7777<br>
							Воронеж, 7 км автодороги Воронеж-Москва +7 (473) 347-77-77
						</a>
					</li>
					<li></li>
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-2 col-sm-2 col-xs-12 no-padding">
			<div class="chenge-shop text-center">
				Выберите салон
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-8 col-sm-8 col-xs-12">
			<span class="grey-form">*Максимальная скидка предоставляется при сдаче автомобиля Hyundai в traid in.</span>
		</div>
	</div>
...
<script>
	...
	$(function(){
		...
		$('.send-profit').click(function(){
			...
			if(phone){
				$.ajax({
					url: 'ajax.php?tel=' + phone + "&street=" + streetShop,
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="form-group">
						<label for="message-text" class="col-form-label">Выберите салон</label>
						<select name="street-shop" class="form-control">
							<option value="ringauto">Воронеж, ул. Изыскателей 39</option>
							<option value="ringauto_sever">Воронеж, 7 км автодороги Воронеж-Москва</option>
						</select>
