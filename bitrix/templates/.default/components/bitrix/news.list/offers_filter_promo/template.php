		...
		<div class="item" id="bx_<?=$arItem['ID']?>">
			...
			<div class="mCarListCards_Item_Info">
				...
				<div class="mCarListCards_Item_Info_Props">
					...
					<span class="t2"><?=myFormatCurrency($arItem['PROPERTIES']['NEW_PRICE']['VALUE'])?></span>
					<span class="t3">Выгода</span>
					<span class="t4"><?=myFormatCurrency($arItem['PROPERTIES']['OLD_PRICE']['VALUE'] - $arItem['PROPERTIES']['NEW_PRICE']['VALUE'])?></span>
