...
_tmr.push({id: "2953631", type: "pageView", start: (new Date()).getTime()});
(function (d, w, id) {
...
<img src="//top-fwz1.mail.ru/counter?id=2953631;js=na" style="border:0;position:absolute;left:-9999px;" alt="" />
</div></noscript>
<!-- //Rating@Mail.ru counter -->


<!-- StreamWood code по просьбе маркетолога от 11.01.2018 (Виктория) -->
...
<script type="text/javascript">
  swQ(document).ready(function(){
    swQ().SW({
      ...
      swDomainKey: 'a8d7b755861ad04dcb98a480b7b4e958'
    });
    swQ('body').SW('load');
  });
</script>
...
<script type="text/javascript" >
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter46709889 = new Ya.Metrika({
                    id:46709889,
                    clickmap:true,
                    trackLinks:true,
