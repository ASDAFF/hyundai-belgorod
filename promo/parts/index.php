...
?>
    ...
    <div class="offers-container">
        <div class="content_area">
            ...
            <img class="promo-head" src="http://www.hyundai.ru/media/offers_image/66a6e0bbd1aec8cbcc70f1c1ea270ba7_banner_zapchasti_1900x530_2.jpg" style="">
            ...
            <div class="offers-content">
                ...
                <div class="navigation">
                    <ul><li><a href="/" title="">Hyundai</a> &gt;</li>
                        <li>Покупка &gt;</li>
                        <li><a href="/all-offers">Акции</a></li>
                    </ul>
                </div>
                ...
                <h1 class="title-offer bordr-btm">Запасные части PL2</h1>
                ...
                <div class="offers-block">
                    ...
                    <div class="offer-terms">
                        ...
                        <p class="offer-terms__text">*Подробную информацию об ассортименте и наличии запасных частей PL2 уточняйте у официальных дилеров Hyundai.</p>
