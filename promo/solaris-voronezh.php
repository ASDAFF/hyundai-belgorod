...
<head>
    ...
    <title>Hyundai Solaris - уже в Воронеже! Запишись на тест-драйв</title>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="http://www.hyundai-ringauto.ru/car/" target="_blank">Модельный ряд</a></li>
               <!-- 
                ...
                <div class="col-md-5">
                    <div class="form-box">
                        <div class="form-text header">
                            ...
                            <p>
                                Выгода до конца месяца!
                            </p>
                            <p class="text-error-header"></p>
                        </div>
                        <form method="" action="">
                                    <input type="text" class="form-control" id="header-tel" placeholder="Ваш телефон">
                                    <input type="text" class="form-control" id="header-email" placeholder="ФИО">

                                    <button type="submit" class="btn btn-default btn-header-block">Оставить заявку</button>
                        </form>
                    </div>
                </div>
            </div>
...
<div class="container-fluid car-back">
    ...
    <div class="row">
        ...
        <div class="container">
            ...
            <div id="accordion">
                <h3><span class="pluse" style="background: url('img/pluse.png');position: absolute;width: 32px;height: 32px;top: 8px;left: 0;"></span> Двигатель</h3>
                <div>
                ...
                <h3><span class="pluse" style="background: url('img/pluse.png');position: absolute;width: 32px;height: 32px;top: 8px;left: 0;"></span> Динамика</h3>
                <div>
                    <table style="width: 100%;font-size: 22px;color: #A0A0A0">
                        <tr>
                ...
                <h3><span class="pluse" style="background: url('img/pluse.png');position: absolute;width: 32px;height: 32px;top: 8px;left: 0;"></span> Расход топлива</h3>
                <div>
                    <table style="width: 100%;font-size: 22px;color: #A0A0A0">
                        <tr>
                ...
                <h3><span class="pluse" style="background: url('img/pluse.png');position: absolute;width: 32px;height: 32px;top: 8px;left: 0;"></span> Подвеска</h3>
                <div>
                    <table style="width: 100%;font-size: 22px;color: #A0A0A0">
                        <tr>
                            <td>Колесная база</td>
