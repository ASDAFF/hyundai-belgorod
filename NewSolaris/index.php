...
?>
    ...
    <link rel="stylesheet" type="text/css" href="/media/css_new/solaris-2017.css"/>

    <!-- <script type="text/javascript" src="/media/js_new/pip_flat_spritespin.js"></script> -->
    <script src="/media/js_new/solaris-2017.js"></script>
    <script src="/media/js_new/solaris-2017-scroll.js"></script>
    <script src="/media/js_new/solaris-2017-parallax.js"></script>
    ...
    <div class="wrap" id="wrap">
        ...
        <div class="img-cache" style="display: none !important;">
            <img src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Platinum-Silver.png"/>
            <img src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Fiery-Red.png"/>
            <img src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Marina-Blue.png"/>
            <img src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Phantom-Black.png"/>
            <img src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Polar-White.png"/>
            <img src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Sunset-Orange.png"/>
            <img src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Urban-Gray.png"/>
        </div>
                ...
                <div class="hero" role="banner" style="display: none">
                    <div class="hero-content">
                        <div class="hero-title">
                            ...
                            <div class="slogan">Новый Hyundai Solaris.</div>
                        </div>
                        <!--
                                        <div class="hero-price">
                                            <div class="hero-price-val">от 553 900 ₽</div>
                                            <div class="hero-proce-credit">В кредит от 9000 ₽ в месяц</div>
                                        </div>
                        -->
                    </div>
                </div>
                    ...
                    <nav class="pip-primary-nav" role="navigation">
                        <div class="pip-primary-nav-w">
                            <ul class="pip-primary-nav-list">
                                ...
                                <li class="pip-primary-nav-item pip-primary-nav-item--to-outside"><a href="/configurator/?car_id=200" class="pip-primary-nav-link">Цены и конфигурации<svg xmlns="http://www.w3.org/2000/svg" class="svg arrow-right-w-tail"><use xlink:href="#arrow-right-w-tail"></use></svg></a></li>
                            </ul>
                        </div>
                        <div class="pip-sub-nav-w">
                            <ul class="pip-sub-nav-list">
                                <li class="pip-sub-nav-item"><a href="#" content-type="explore" data-anchor="configurator" class="pip-sub-nav-link">Твой Solaris</a></li>
                ...
                <div class="content-type content-type__explore is-active" content-type="explore">
                    <section class="section section--configurator" data-anchor="configurator">
                        <div class="section-content section-content--fw section-content--configurator">
                            <header class="section-header">
                                <div class="section-header__subtitle">Создай свой<br> Solaris</div>
                            </header>
                            <div class="configurator">
                                <div class="backstage">Solaris</div>
                                <div class="img-w">
                                    <img src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Marina-Blue.png" class="img" data-role="js-360-preview" alt=""/>
                                </div>
                                <div class="configurator-controls dublay">
                                    <div class="configurator-control dublay-ch dublay-ch--by-50">
                                        <ul class="configurator-360-selectors">
                                            <li class="configurator-360-selector is-active" data-src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Marina-Blue.png" data-name="Marina Blue"><span style="color: #325488"></span></li>
                                            <li class="configurator-360-selector" data-src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Platinum-Silver.png" data-name="Sleek Silver"><span style="color: #cfcfcf"></span></li>
                                            <li class="configurator-360-selector" data-src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Fiery-Red.png" data-name="Fiery Red"><span style="color: #c64040"></span></li>
                                            <li class="configurator-360-selector" data-src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Phantom-Black.png" data-name="Phantom Black"><span style="color: #08090b"></span></li>
                                            <li class="configurator-360-selector" data-src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Polar-White.png" data-name="Crystal White"><span style="color: #f0f0f0"></span></li>
                                            <li class="configurator-360-selector" data-src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Sunset-Orange.png" data-name="Sunset Orange"><span style="color: #d87c5a"></span></li>
                                            <li class="configurator-360-selector" data-src="/media/images/flat/SL2017/360/Solaris-2017_Colors-Urban-Gray.png" data-name="Urban Gray"><span style="color: #7f7f7f"></span></li>
                                        </ul>
                                        <span class="configurator-360-color-name">Marina Blue</span>
                                    </div>
                                    <div class="configurator-control dublay-ch dublay-ch--by-50">
                                        <a href="/configurator/?car_id=200" class="configurator-link">
                                            <div class="configurator-link-text">
                                                от <span class="configurator-price-val">599 000</span> &#8381;
                        ...
                        <div class="section-content">
                            <div class="video" data-role="js-video" data-watch-scroll="true">
                                <div class="pip-slider pip-slider--video">
                                    <div class="pip-slide" data-slide="1" data-src="gA-Sum0Mj08">
                                        <div class="pip-slide__content">
                                            <img src="/media/images/flat/SL2017/elements/video_preview_1.jpg" class="video-preview" alt=""/>
                    ...
                    <section class="section section--brand-new" data-anchor="highlights">
                        ...
                        <div class="section-content section-content--fw section-content--highlights-specs" data-watch-scroll="true">
                            <header class="section-header">
                                <div class="section-header__subtitle">Новый во всем</div>
                            </header>
                            <div class="section-main">
                                <div class="img-w">
                                    <img src="/media/images/flat/SL2017/elements/specs.png" class="img" alt=""/>
                                </div>
                                <div class="pip-specs">
                                    <div class="pip-specs-row">
                                        <div class="pip-specs-el">
                                            <span class="pip-specs-val">1160 кг</span>
                                            <span class="pip-specs-name">снаряженная масса</span>
                                        </div>
                                        <div class="pip-specs-el">
                                            <span class="pip-specs-val">1.6 л</span>
                                            <span class="pip-specs-name">объем двигателя</span>
                                        </div>
                                    </div>
                                    <div class="pip-specs-row">
                                        <div class="pip-specs-el">
                                            <span class="pip-specs-val">4.405 м</span>
                                            <span class="pip-specs-name">длина</span>
                                        </div>
                                        <div class="pip-specs-el">
                                            <span class="pip-specs-val">123 л.с.</span>
                                    ...
                                    <div class="pip-specs-row">
                                        ...
                                        <div class="pip-specs-el">
                                            <span class="pip-specs-val">193 км/ч</span>
                                            <span class="pip-specs-name">макс. скорость</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- 						<a href="#" class="brochure-dl">Скачать брошюру <i class="pip-ic"><svg xmlns="http://www.w3.org/2000/svg" class="svg arrow-dl"><use xlink:href="#arrow-dl"></use></svg></i></a> -->
                            </div>
                        </div>
                                ...
                                <div class="pip-slider pip-slider--hlsl">
                                    <div class="pip-slides-holder">
                                        ...
                                        <div class="pip-slide" data-slide="3">
                                            <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/highlights_1.jpg" class="pip-slide-img" alt=""/></div>
                                            <div class="pip-slide-text">
                                                <div class="pip-slide-subt">
                                                    Комфортный
                                                </div>
                                ...
                                <div class="pip-slider pip-slider--exterior">
                                    <div class="pip-slides-holder">
                                        <div class="pip-slide" data-slide="1">
                                            <div class="pip-slide__content">
                                                <div class="exterior-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/angle_1.png" class="exterior-angle" alt=""/>
                                                </div>
                                        ...
                                        <div class="pip-slide" data-slide="2">
                                            <div class="pip-slide__content">
                                                <div class="exterior-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/angle_2.png" class="exterior-angle" alt=""/>
                                                </div>
                                                <div class="exterior-plus-area">
                                ...
                                <div class="pip-slider pip-slider--exterior-pluser" data-role="js-ext-pluser">
                                    <div class="pip-slides-holder">
                                        <div class="pip-slide" data-slide="1">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/exterior_1.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                                    <strong class="pluser-text-title">Решётка радиатора</strong>
                                                    Новая решетка радиатора прибавляет автомобилю элегантности и подчеркивает принадлежность к семейству автомобилей Hyundai.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pip-slide" data-slide="2">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/exterior_2.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                                    <strong class="pluser-text-title">Противотуманные фары</strong>
                                                    Противотуманные фары обеспечивают великолепную видимость даже в тяжелые погодные условия.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pip-slide" data-slide="3">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/exterior_3.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                        ...
                                        <div class="pip-slide" data-slide="4">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/exterior_4.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                        ...
                                        <div class="pip-slide" data-slide="5">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/exterior_5.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                                    <strong class="pluser-text-title">Задние LED-фонари</strong>
                                                    Стильные задние LED-фонари теперь будут притягивать ещё больше восхищенных взглядов.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="section-parallax section-parallax--3">
                            ...
                            <div class="section-parallax-content" data-parallax-speed="2">
                                <header class="section-header">
                                    ...
                                    <div class="section-header__subtitle">Создан для вас</div>
                                    <span class="section-header__descr">Solaris сочетает экономичность и удобство городского седана.</span>
                                </header>
                            </div>
                        </div>
                        <div class="section-content section-content--fw">
                                        ...
                                        <div class="pip-slide" data-slide="1">
                                            <div class="pip-slide__content">
                                                <div class="interior-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/interior_view.jpg" class="interior-view" alt=""/>
                                                </div>
                                                <div class="interior-plus-area">
                                                    ...
                                                    <button class="plus" data-for="7"></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="pip-slider pip-slider--interior-pluser" data-role="js-interior-pluser">
                                    <div class="pip-slides-holder">
                                        ...
                                        <div class="pip-slide" data-slide="1">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/interior_1.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                                    <strong class="pluser-text-title">Выдвижной подлокотник</strong>
                                                    Выдвижной подлокотник — незаменимый помощник в дальних поездках.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pip-slide" data-slide="2">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/interior_2.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                                    <strong class="pluser-text-title">Регулировка водительского сиденья</strong>
                                                    Задайте нужные положения водительского сидения, что
                                                    позволит с комфортом преодолеть
                                        ...
                                        <div class="pip-slide" data-slide="3">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/interior_3.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                                    <strong class="pluser-text-title">Электроусилитель руля</strong>
                                                    Электроусилитель рулевого управления — это конструктивный элемент в рулевом управлении автомобиля, который создает дополнительное усилие во время поворота рулевого колеса при помощи электрического привода.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pip-slide" data-slide="4">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/interior_4.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                                    <strong class="pluser-text-title">Регулировка руля в четырёх направлениях</strong>
                                                    Новый Solaris имеет чуткий руль с обогревом, который, в добавок к этому, регулируется в четырёх направлениях.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pip-slide" data-slide="5">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/interior_5.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                                    <strong class="pluser-text-title">Кнопка ≪Старт≫</strong>
                                        ...
                                        <div class="pip-slide" data-slide="6">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/interior_6.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                                    <strong class="pluser-text-title">USB- и AUX-порты</strong>
                                                    USB и AUX порты помогут упростить взаимодействие с мультимедийной системой автомобиля.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pip-slide" data-slide="7">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/interior_7.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                    ...
                    <section class="section section--performance" data-anchor="performance">
                        <div class="section-parallax section-parallax--4">
                            ...
                            <div class="section-parallax-content" data-parallax-speed="2">
                                <header class="section-header">
                                    ...
                                    <div class="section-header__subtitle">Превосходит ожидания</div>
                                    <span class="section-header__descr">За 6 лет Hyundai Solaris стал поистине народным автомобилем.</span>
                                </header>
                            </div>
                        </div>
                            ...
                            <div class="section-main" data-role="js-graphics" data-watch-scroll="true">
                                <div class="tabs graphics-tabs">
                                    <ul class="tabs-w engine-selector" data-role="tabs-buttons">
                                        <li class="tab is-active" data-for="1" data-power="99.66" data-toque="132.4" data-power-scale="75" data-toque-scale="25.2">1.4 MPi</li>
                                        <li class="tab" data-for="2" data-power="123" data-toque="150.7" data-power-scale="85" data-toque-scale="45.5">1.6 MPi</li>
                                    </ul>
                                    <ul class="tabs-c" data-role="tab-container">
                                        <li class="tab" data-tab="1"><div class="engine-descr">Базовая версия  Solaris комплектуется проверенным  двигателем  KAPPA с надежной 6-ступенчатой МКПП.</div></li>
                                        <li class="tab" data-tab="2"><div class="engine-descr">В новом Solaris доступен инновационный двигатель Gamma с 6-ступенчатой АКПП, отличающийся повышенной мощностью и увеличенным крутящим моментом.</div></li>
                                    </ul>
                                    <div class="graphics-scores">
                                        ...
                                        <div class="graphics-score graphics-score--power">
                                            <dl class="score-points">
                                                <dt class="points"><strong class="value">99.66</strong> <span class="units">л.с.</span></dt>
                                        ...
                                        <div class="graphics-score graphics-score--toque">
                                            <dl class="score-points">
                                                <dt class="points"><strong class="value">132.4</strong> <span class="units">Нм</span></dt>
                        ...
                        <div class="section-content section-content--fw section-content--transmission">
                            <div class="section-main transmission-w" data-role="js-transmission">
                                <div class="transmissions dublay">
                                    <div class="transmission dublay-ch dublay-ch--by-50" data-for="1">
                                        <img src="/media/images/flat/SL2017/elements/performance_1.jpg" class="transmission-img" alt=""/>
                                        <button class="more-button"><svg xmlns="http://www.w3.org/2000/svg" class="svg"><use xlink:href="#plus"></use></svg></button>
                                    </div>
                                    <div class="transmission dublay-ch dublay-ch--by-50" data-for="2">
                                        <img src="/media/images/flat/SL2017/elements/performance_2.jpg" class="transmission-img" alt=""/>
                                        <button class="more-button"><svg xmlns="http://www.w3.org/2000/svg" class="svg"><use xlink:href="#plus"></use></svg></button>
                                    </div>
                                </div>
                                <div class="transmissions-slider" data-role="js-transmission-slider">
                                    <div class="pip-slides-holder">
                                        <div class="pip-slide" data-slide="1">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/performance_popup_1.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                        ...
                                        <div class="pip-slide" data-slide="2">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/performance_popup_2.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                        ...
                        <div class="section-parallax section-parallax--5">
                            ...
                            <div class="section-parallax-content" data-parallax-speed="2">
                                <header class="section-header">
                                    ...
                                    <div class="section-header__subtitle">Всесторонняя защита</div>
                                    <span class="section-header__descr">Отдыхайте и наслаждайтесь поездкой, технологии на страже безопасности.</span>
                                </header>
                            </div>
                        </div>
                        <div class="section-content section-content--fw">
                                    ...
                                    <div class="dublay-ch dublay-ch--by-50" data-pip-subslide="left">
                                        <div class="pip-slides-holder">
                                            <div class="pip-slide" data-slide="1" data-slide-type="static">
                                                ...
                                                <div class="pip-slide-descr">
                                                    Фронтальные и боковые передние подушки безопасности, а также шторки безопасности для передних и задних пассажиров делают Solaris одним из самых защищенных автомобилей в своем классе.
                                                </div>
                                            </div>
                                            <div class="pip-slide" data-slide="2" data-slide-type="static">
                                                ...
                                                <div class="pip-slide-descr">
                                                    Государственная система экстренного реагирования при авариях «ЭРА-ГЛОНАСС» – это использование технологий ГЛОНАСС в целях повышения безопасности на транспорте.
                                                </div>
                                            </div>
                                    ...
                                    <div class="dublay-ch dublay-ch--by-50" data-pip-subslide="right">
                                        <div class="pip-slides-holder">
                                            <div class="pip-slide" data-slide="1" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/safety_popup_1.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                            <div class="pip-slide" data-slide="2" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/safety_popup_2.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                            <div class="pip-slide" data-slide="3" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/safety_popup_3.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="convience-popups dublay">
                                    <div class="dublay-ch dublay-ch--by-50">
                                        <div class="convience-popup" data-for="1">
                                            <div class="convience-popup-inner">
                                                <img src="/media/images/flat/SL2017/elements/convenience_1.png" class="convience-popup-img" alt=""/>
                                    ...
                                    <div class="dublay-ch dublay-ch--by-50">
                                        <div class="convience-popup" data-for="2">
                                            <div class="convience-popup-inner">
                                                <img src="/media/images/flat/SL2017/elements/convenience_2.jpg" class="convience-popup-img" alt=""/>
                                                <div class="convience-popup-title">Панель Supervision</div>
                                                <button class="more-button"><svg xmlns="http://www.w3.org/2000/svg" class="svg"><use xlink:href="#plus"></use></svg></button>
                                            </div>
                                        </div>
                                        <div class="convience-popup" data-for="3">
                                            <div class="convience-popup-inner">
                                                <img src="/media/images/flat/SL2017/elements/convenience_3.jpg" class="convience-popup-img" alt=""/>
                                ...
                                <div class="convience-popups-slider" data-role="js-convience-popups-slider">
                                    <div class="pip-slides-holder">
                                        <div class="pip-slide" data-slide="1">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/convenience_popup_1.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                        ...
                                        <div class="pip-slide" data-slide="2">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/convenience_popup_2.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                                                    <strong class="pluser-text-title">Приборная панель</strong>
                                                    Приборная панель с тахометром и спидометром
                                                    имеет бело-синюю подсветку, что позволяет
                                                    водителю легко считывать данные в любых условиях.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pip-slide" data-slide="3">
                                            <div class="pip-slide__content">
                                                <div class="pluser-image-area">
                                                    <img src="/media/images/flat/SL2017/elements/convenience_popup_3.jpg" class="pluser-img" alt=""/>
                                                </div>
                                                <div class="pluser-text-area">
                            ...
                            <div class="convience-slider" data-role="js-convience-slider">
                                <div class="dublay pip-slider pip-slider--convience">
                                    <div class="dublay-ch dublay-ch--by-50" data-pip-subslide="left">
                                        <div class="pip-slides-holder">
                                            <div class="pip-slide" data-slide="1" data-slide-type="static">
                                                ...
                                                <div class="pip-slide-descr">
                                                    Благодаря подогреву форсунок стеклоомывателя водитель в любую погоду сможет поддерживать чистоту лобового стекла.
                                                </div>
                                            </div>
                                            <div class="pip-slide" data-slide="2" data-slide-type="static">
                                                <div class="pip-slide-subt">
                                                ...
                                                <div class="pip-slide-descr">
                                                    В новом Solaris мы увеличили ёмкость бензобака, что позволит совершать путешествия на более дальние расстояния.
                                                </div>
                                            </div>
                                            <div class="pip-slide" data-slide="3" data-slide-type="static">
                                                <div class="pip-slide-subt">
                                                ...
                                                <div class="pip-slide-descr">
                                                    Быстрый подогрев передних и задних сидений не даст водителю и пассажирам замерзнуть и сделает поездки более комфортными.
                                                </div>
                                            </div>
                                            <div class="pip-slide" data-slide="4" data-slide-type="static">
                                                <div class="pip-slide-subt">
                                                    Увеличенный объем бачка омывающей жидкости
                                                </div>
                                                <div class="pip-slide-descr">
                                                    Ёмкость бачка омывателя в новом Solaris увеличена.
                                                </div>
                                            </div>
                                            <div class="pip-slide" data-slide="5" data-slide-type="static">
                                                ...
                                                <div class="pip-slide-descr">
                                                    Полноразмерное запасное колесо — незаменимая деталь для каждого водителя.
                                                </div>
                                            </div>
                                            <!--
                                                                                <div class="pip-slide" data-slide="6" data-slide-type="static">
                                                                                    <div class="pip-slide-subt">
                                                                                        Камера заднего вида
                                                                                    </div>
                                                                                    <div class="pip-slide-descr">
                                                                                        Камера заднего вида упрощает маневрирование в узких местах при движении задним ходом.
                                                                                    </div>
                                                                                </div>
                                            -->
                                            <div class="pip-slide" data-slide="6" data-slide-type="static">
                                                ...
                                                <div class="pip-slide-descr">
                                                    Стандартные статичные боковые лампы позволяют
                                                    водителю видеть больше деталей при повороте или
                                                    движении по дуге.
                                                </div>
                                            </div>
                                            <div class="pip-slide" data-slide="7" data-slide-type="static">
                                                <div class="pip-slide-subt">
                                                    Бокс для очков
                                                </div>
                                                <div class="pip-slide-descr">
                                                    Бокс для очков поможет хранить данный аксессуар в удобном и легкодоступном месте.
                                                </div>
                                            </div>
                                            <div class="pip-slide" data-slide="8" data-slide-type="static">
                                                <div class="pip-slide-subt">
                                                    Автоматическое открывание багажника
                                                </div>
                                                <div class="pip-slide-descr">
                                                    Багажник в новом Solaris открывается автоматически из салона, что позволяет водителю не пачкать руки, трогая наружные части автомобиля.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="dublay-ch dublay-ch--by-50" data-pip-subslide="right">
                                        <div class="pip-slides-holder">
                                            <div class="pip-slide" data-slide="1" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/convenience_slider_1.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                            <div class="pip-slide" data-slide="2" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/convenience_slider_2.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                            <div class="pip-slide" data-slide="3" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/convenience_slider_3.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                            <div class="pip-slide" data-slide="4" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/convenience_slider_4.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                            <div class="pip-slide" data-slide="5" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/convenience_slider_5.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                            <!--
                                                                                <div class="pip-slide" data-slide="6" data-slide-type="mooving">
                                                                                    <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/convenience_slider_6.jpg" class="pip-slide-img" alt=""/></div>
                                                                                </div>
                                            -->
                                            <div class="pip-slide" data-slide="6" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/convenience_slider_7.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                            <div class="pip-slide" data-slide="7" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/convenience_slider_8.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                            <div class="pip-slide" data-slide="8" data-slide-type="mooving">
                                                <div class="pip-slide-image"><img src="/media/images/flat/SL2017/elements/convenience_slider_9.jpg" class="pip-slide-img" alt=""/></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <li class="listing-item">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>1 516 / 1 510<br>(шины 15" / 16")</td>
                                                <td>1 516 / 1 510<br>(шины 15" / 16")</td>
                                                <td>1 516 / 1 510<br>(шины 15" / 16")</td>
                                                <td>1 516 / 1 510<br>(шины 15" / 16")</td>
                                            </tr>
                                            <tr>
                                                <th>Задняя колея</th>
                                                <td>1 524 / 1 518<br>(шины 15" / 16")</td>
                                                <td>1 524 / 1 518<br>(шины 15" / 16")</td>
                                                <td>1 524 / 1 518<br>(шины 15" / 16")</td>
                                                <td>1 524 / 1 518<br>(шины 15" / 16")</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>независимая, пружинная,<br/>типа McPherson<br/>с гидравлическими телескопическими<br/>амортизаторами,<br/> со стабилизатором<br/>поперечной устойчивости </td>
                                                <td>независимая, пружинная,<br/>типа McPherson<br/>с гидравлическими телескопическими<br/>амортизаторами,<br/> со стабилизатором<br/>поперечной устойчивости </td>
                                                <td>независимая, пружинная,<br/>типа McPherson<br/>с гидравлическими телескопическими<br/>амортизаторами,<br/> со стабилизатором<br/>поперечной устойчивости </td>
                                                <td>независимая, пружинная,<br/>типа McPherson<br/>с гидравлическими телескопическими<br/>амортизаторами,<br/> со стабилизатором<br/>поперечной устойчивости </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>полузависимая, пружинная,<br/>с гидравлическими телескопическими<br/>амортизаторами,<br/>со стабилизатором<br/>поперечной устойчивости</td>
                                                <td>полузависимая, пружинная,<br/>с гидравлическими телескопическими<br/>амортизаторами,<br/>со стабилизатором<br/>поперечной устойчивости</td>
                                                <td>полузависимая, пружинная,<br/>с гидравлическими телескопическими<br/>амортизаторами,<br/>со стабилизатором<br/>поперечной устойчивости</td>
                                                <td>полузависимая, пружинная,<br/>с гидравлическими телескопическими<br/>амортизаторами,<br/>со стабилизатором<br/>поперечной устойчивости</td>
                                            </tr>
                    ...
                    <div id="contents_gallery" class="contents_gallery pip">
                        <div class="gallery_wrap">
                            ...
                            <ul id="all-gallery-items"style="display: none;">
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/1.jpg" data-href="/media/images/flat/SL2017/gallery/1.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/2.jpg" data-href="/media/images/flat/SL2017/gallery/2.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/3.jpg" data-href="/media/images/flat/SL2017/gallery/3.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/4.jpg" data-href="/media/images/flat/SL2017/gallery/4.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/5.jpg" data-href="/media/images/flat/SL2017/gallery/5.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/6.jpg" data-href="/media/images/flat/SL2017/gallery/6.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/7.jpg" data-href="/media/images/flat/SL2017/gallery/7.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/8.jpg" data-href="/media/images/flat/SL2017/gallery/8.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/9.jpg" data-href="/media/images/flat/SL2017/gallery/9.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/10.jpg" data-href="/media/images/flat/SL2017/gallery/10.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/11.jpg" data-href="/media/images/flat/SL2017/gallery/11.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/12.jpg" data-href="/media/images/flat/SL2017/gallery/12.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/13.jpg" data-href="/media/images/flat/SL2017/gallery/13.jpg"/></li>
                                <!--
                                                        <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/14.jpg" data-href="/media/images/flat/SL2017/gallery/14.jpg"/></li>
                                                        <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/15.jpg" data-href="/media/images/flat/SL2017/gallery/15.jpg"/></li>
                                                        <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/16.jpg" data-href="/media/images/flat/SL2017/gallery/16.jpg"/></li>
                                -->
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/17.jpg" data-href="/media/images/flat/SL2017/gallery/17.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/18.jpg" data-href="/media/images/flat/SL2017/gallery/18.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/19.jpg" data-href="/media/images/flat/SL2017/gallery/19.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/20.jpg" data-href="/media/images/flat/SL2017/gallery/20.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/21.jpg" data-href="/media/images/flat/SL2017/gallery/21.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/22.jpg" data-href="/media/images/flat/SL2017/gallery/22.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/23.jpg" data-href="/media/images/flat/SL2017/gallery/23.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/24.jpg" data-href="/media/images/flat/SL2017/gallery/24.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/25.jpg" data-href="/media/images/flat/SL2017/gallery/25.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/26.jpg" data-href="/media/images/flat/SL2017/gallery/26.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/27.jpg" data-href="/media/images/flat/SL2017/gallery/27.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/28.jpg" data-href="/media/images/flat/SL2017/gallery/28.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="" src="/media/images/flat/SL2017/gallery/previews/29.jpg" data-href="/media/images/flat/SL2017/gallery/29.jpg"/></li>
                            </ul>
                            <!--  -->
