                                        ...
                                        <div class="configurator-control dublay-ch dublay-ch--by-50">
                                            <a href="http://www.hyundai.ru/configurator" target="_blank" class="configurator-link">
                                                <div class="configurator-link-text">
                                                    <span class="configurator-price-val">от 730 000 ₽</span>
                    ...
                    <div class="prefooter">
                        <div class="prefooter-c">
                            <ul class="prefooter-l">
                                <li class="prefooter-l-i"><a href="http://hyundai-belgorod.ru/configurator/car/23" target="_blank" class="prefooter-l-l"><svg xmlns="http://www.w3.org/2000/svg" class="svg"><use xlink:href="#ic-config"></use></svg><span class="prefooter-l-t">Конфигуратор</span></a></li>
                                ...
                                <li class="prefooter-l-i"><a href="http://hyundai-belgorod.ru/configurator/car/23#calculator" target="_blank" class="prefooter-l-l"><svg xmlns="http://www.w3.org/2000/svg" class="svg"><use xlink:href="#ic-credit"></use></svg><span class="prefooter-l-t">Расчет кредита</span></a></li>
                            </ul>
