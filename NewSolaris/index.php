                                    ...
                                    <div class="item_wrap">
                                        <div class="main mkv">
                                            ...
                                            <div class="title-price">
                                                ...
                                                <a href="http://www.hyundai.ru/configurator" target="_blank" class="title-price-notice">В кредит от 6000 ₽ / месяц</a>
                                            </div>
                        ...
                        <section class="section section--brand-new" data-anchor="highlights">
                            ...
                            <div class="section-content section-content--fw section-content--highlights-specs" data-watch-scroll="true">
                                ...
                                <div class="section-main">
                                    ...
                                    <a data-gtm-havas-model="solaris" href="#" data-model="Solaris New" for="brochures_request" class="brochure-dl zing_form_toggler broshure">Скачать каталог <i class="pip-ic"><svg xmlns="http://www.w3.org/2000/svg" class="svg arrow-dl"><use xlink:href="#arrow-dl"></use></svg></i></a>
                                </div>
                            </div>
                    ...
                    <div class="prefooter">
                        <div class="prefooter-c">
                            <ul class="prefooter-l">
                                <li class="prefooter-l-i"><a href="http://www.hyundai.ru/configurator/car/23" target="_blank" class="prefooter-l-l"><svg xmlns="http://www.w3.org/2000/svg" class="svg"><use xlink:href="#ic-config"></use></svg><span class="prefooter-l-t">Конфигуратор</span></a></li>
                            ...
                            <p>
                                **Платеж рассчитан по программе Hyundai Старт с учетом государственной программы льготного автокредитования исходя из цены Solaris 1.4 6MT Active (Актив) 624 900 р., срок кредита 36 мес., процентная ставка 8.3% годовых, первоначальный взнос 215 000 р., сумма кредита 409 900 р. Гарантированная остаточная стоимость автомобиля (часть стоимости автомобиля, подлежащая оплате в конце срока кредита) ― 45% от цены на момент покупки. Обязательно оформление полиса КАСКО на весь срок кредита в страховых компаниях, соответствующих требованиям Банка. Кредит предоставляется ООО «Русфинанс Банк» Генеральная лицензия ЦБ РФ №1792 от 13.02.2013 г. Предложение действует с 01.11.17 по 30.11.17, не является офертой. Условия могут быть изменены Банком в одностороннем порядке. Подробные условия кредитования на сайте www.rusfinancebank.ru.<br/>
