! function() {
    ...
    var e, a = function(t, s) {
        ...
        function d(e) {
            ...
            if (0 !== a) {
                if (y.params.mousewheelInvert && (a = -a), y.params.freeMode) {
                    var i = y.getWrapperTranslate() + a * y.params.mousewheelSensitivity,
                        r = y.isBeginning,
                        n = y.isEnd;
                    if (i >= y.minTranslate() && (i = y.minTranslate()), i <= y.maxTranslate() && (i = y.maxTranslate()), y.setWrapperTransition(0), y.setWrapperTranslate(i), y.updateProgress(), y.updateActiveIndex(), (!r && y.isBeginning || !n && y.isEnd) && y.updateClasses(), y.params.freeModeSticky ? (clearTimeout(y.mousewheel.timeout), y.mousewheel.timeout = setTimeout(function() {
                            y.slideReset()
                        }, 300)) : y.params.lazyLoading && y.lazy && y.lazy.load(), y.emit("onScroll", y, e), y.params.autoplay && y.params.autoplayDisableOnInteraction && y.stopAutoplay(), 0 === i || i === y.maxTranslate()) return
                } else {
        ...
        function c(a, t) {
            ...
            s = a.attr("data-swiper-parallax") || "0", i = a.attr("data-swiper-parallax-x"), r = a.attr("data-swiper-parallax-y"), i || r ? (i = i || "0", r = r || "0") : y.isHorizontal() ? (i = s, r = "0") : (r = s, i = "0"), i = i.indexOf("%") >= 0 ? parseInt(i, 10) * t * n + "%" : i * t * n + "px", r = r.indexOf("%") >= 0 ? parseInt(r, 10) * t + "%" : r * t + "px", a.transform("translate3d(" + i + ", " + r + ",0px)")
        }
        ...
        var g = {};
        for (var v in s)
            if ("object" != typeof s[v] || null === s[v] || s[v].nodeType || s[v] === window || s[v] === document || "undefined" != typeof Dom7 && s[v] instanceof Dom7 || "undefined" != typeof jQuery && s[v] instanceof jQuery) g[v] = s[v];
            else {
                g[v] = {};
                for (var f in s[v]) g[v][f] = s[v][f]
            }
        for (var w in m)
            if (void 0 === s[w]) s[w] = m[w];
            else if ("object" == typeof s[w])
                for (var x in m[w]) void 0 === s[w][x] && (s[w][x] = m[w][x]);
        var y = this;
        if (y.params = s, y.originalParams = g, y.classNames = [], void 0 !== e && "undefined" != typeof Dom7 && (e = Dom7), (void 0 !== e || (e = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (y.$ = e, y.currentBreakpoint = void 0, y.getActiveBreakpoint = function() {
            ...
            y.container[0].swiper = y, y.container.data("swiper", y), y.classNames.push(y.params.containerModifierClass + y.params.direction), y.params.freeMode && y.classNames.push(y.params.containerModifierClass + "free-mode"), y.support.flexbox || (y.classNames.push(y.params.containerModifierClass + "no-flexbox"), y.params.slidesPerColumn = 1), y.params.autoHeight && y.classNames.push(y.params.containerModifierClass + "autoheight"), (y.params.parallax || y.params.watchSlidesVisibility) && (y.params.watchSlidesProgress = !0), y.params.touchReleaseOnEdges && (y.params.resistanceRatio = 0), ["cube", "coverflow", "flip"].indexOf(y.params.effect) >= 0 && (y.support.transforms3d ? (y.params.watchSlidesProgress = !0, y.classNames.push(y.params.containerModifierClass + "3d")) : y.params.effect = "slide"), "slide" !== y.params.effect && y.classNames.push(y.params.containerModifierClass + y.params.effect), "cube" === y.params.effect && (y.params.resistanceRatio = 0, y.params.slidesPerView = 1, y.params.slidesPerColumn = 1, y.params.slidesPerGroup = 1, y.params.centeredSlides = !1, y.params.spaceBetween = 0, y.params.virtualTranslate = !0), "fade" !== y.params.effect && "flip" !== y.params.effect || (y.params.slidesPerView = 1, y.params.slidesPerColumn = 1, y.params.slidesPerGroup = 1, y.params.watchSlidesProgress = !0, y.params.spaceBetween = 0, void 0 === h && (y.params.virtualTranslate = !0)), y.params.grabCursor && y.support.touch && (y.params.grabCursor = !1), y.wrapper = y.container.children("." + y.params.wrapperClass), y.params.pagination && (y.paginationContainer = e(y.params.pagination), y.params.uniqueNavElements && "string" == typeof y.params.pagination && y.paginationContainer.length > 1 && 1 === y.container.find(y.params.pagination).length && (y.paginationContainer = y.container.find(y.params.pagination)), "bullets" === y.params.paginationType && y.params.paginationClickable ? y.paginationContainer.addClass(y.params.paginationModifierClass + "clickable") : y.params.paginationClickable = !1, y.paginationContainer.addClass(y.params.paginationModifierClass + y.params.paginationType)), (y.params.nextButton || y.params.prevButton) && (y.params.nextButton && (y.nextButton = e(y.params.nextButton), y.params.uniqueNavElements && "string" == typeof y.params.nextButton && y.nextButton.length > 1 && 1 === y.container.find(y.params.nextButton).length && (y.nextButton = y.container.find(y.params.nextButton))), y.params.prevButton && (y.prevButton = e(y.params.prevButton), y.params.uniqueNavElements && "string" == typeof y.params.prevButton && y.prevButton.length > 1 && 1 === y.container.find(y.params.prevButton).length && (y.prevButton = y.container.find(y.params.prevButton)))), y.isHorizontal = function() {
            ...
            }, y.params.grabCursor && y.setGrabCursor(), y.imagesToLoad = [], y.imagesLoaded = 0, y.loadImage = function(e, a, t, s, i, r) {
                function n() {
                    r && r()
                }
                var o;
                ...
                if (void 0 !== y.size) {
                    ...
                    for (e = 0; e < y.slides.length; e++) {
                        ...
                        if (y.params.slidesPerColumn > 1) {
                            var u, m, h;
                            "column" === y.params.slidesPerColumnFill ? (m = Math.floor(e / l), h = e - m * l, (m > d || m === d && h === l - 1) && ++h >= l && (h = 0, m++), u = m + h * n / l, c.css({
                                "-webkit-box-ordinal-group": u,
                                "-moz-box-ordinal-group": u,
                                "-ms-flex-order": u,
                                "-webkit-order": u,
                                order: u
                            })) : (h = Math.floor(e / p), m = e - h * p), c.css("margin-" + (y.isHorizontal() ? "top" : "left"), 0 !== h && y.params.spaceBetween && y.params.spaceBetween + "px").attr("data-swiper-column", m).attr("data-swiper-row", h)
                        }
                ...
                var e, a, t = 1;
                if (y.params.centeredSlides) {
                    var s, i = y.slides[y.activeIndex].swiperSlideSize;
                    for (e = y.activeIndex + 1; e < y.slides.length; e++) y.slides[e] && !s && (i += y.slides[e].swiperSlideSize, t++, i > y.size && (s = !0));
                    for (a = y.activeIndex - 1; a >= 0; a--) y.slides[a] && !s && (i += y.slides[a].swiperSlideSize, t++, i > y.size && (s = !0))
                } else
                ...
                if (void 0 === e && (e = y.translate || 0), 0 !== y.slides.length) {
                    ...
                    for (var t = 0; t < y.slides.length; t++) {
                        var s = y.slides[t],
                            i = (a + (y.params.centeredSlides ? y.minTranslate() : 0) - s.swiperSlideOffset) / (s.swiperSlideSize + y.params.spaceBetween);
                        if (y.params.watchSlidesVisibility) {
                            var r = -(a - s.swiperSlideOffset),
                                n = r + y.slidesSizesGrid[t];
                            (r >= 0 && r < y.size || n > 0 && n <= y.size || r <= 0 && n >= y.size) && y.slides.eq(t).addClass(y.params.slideVisibleClass)
                        }
                ...
                y.params.normalizeSlideIndex && (e < 0 || void 0 === e) && (e = 0), t = Math.floor(e / y.params.slidesPerGroup), t >= y.snapGrid.length && (t = y.snapGrid.length - 1), e !== y.activeIndex && (y.snapIndex = t, y.previousIndex = y.activeIndex, y.activeIndex = e, y.updateClasses(), y.updateRealIndex())
                ...
                y.params.loop && 0 === t.length && (t = y.slides.eq(0), t.addClass(y.params.slideNextClass));
                var i = a.prev("." + y.params.slideClass).addClass(y.params.slidePrevClass);
                if (y.params.loop && 0 === i.length && (i = y.slides.eq(-1), i.addClass(y.params.slidePrevClass)), s.loop && (t.hasClass(y.params.slideDuplicateClass) ? y.wrapper.children("." + y.params.slideClass + ":not(." + y.params.slideDuplicateClass + ')[data-swiper-slide-index="' + t.attr("data-swiper-slide-index") + '"]').addClass(y.params.slideDuplicateNextClass) : y.wrapper.children("." + y.params.slideClass + "." + y.params.slideDuplicateClass + '[data-swiper-slide-index="' + t.attr("data-swiper-slide-index") + '"]').addClass(y.params.slideDuplicateNextClass), i.hasClass(y.params.slideDuplicateClass) ? y.wrapper.children("." + y.params.slideClass + ":not(." + y.params.slideDuplicateClass + ')[data-swiper-slide-index="' + i.attr("data-swiper-slide-index") + '"]').addClass(y.params.slideDuplicatePrevClass) : y.wrapper.children("." + y.params.slideClass + "." + y.params.slideDuplicateClass + '[data-swiper-slide-index="' + i.attr("data-swiper-slide-index") + '"]').addClass(y.params.slideDuplicatePrevClass)), y.paginationContainer && y.paginationContainer.length > 0) {
                    var r, n = y.params.loop ? Math.ceil((y.slides.length - 2 * y.loopedSlides) / y.params.slidesPerGroup) : y.snapGrid.length;
                    if (y.params.loop ? (r = Math.ceil((y.activeIndex - y.loopedSlides) / y.params.slidesPerGroup), r > y.slides.length - 1 - 2 * y.loopedSlides && (r -= y.slides.length - 2 * y.loopedSlides), r > n - 1 && (r -= n), r < 0 && "bullets" !== y.params.paginationType && (r = n + r)) : r = void 0 !== y.snapIndex ? y.snapIndex : y.activeIndex || 0, "bullets" === y.params.paginationType && y.bullets && y.bullets.length > 0 && (y.bullets.removeClass(y.params.bulletActiveClass), y.paginationContainer.length > 1 ? y.bullets.each(function() {
                            e(this).index() === r && e(this).addClass(y.params.bulletActiveClass)
                        }) : y.bullets.eq(r).addClass(y.params.bulletActiveClass)), "fraction" === y.params.paginationType && (y.paginationContainer.find("." + y.params.paginationCurrentClass).text(r + 1), y.paginationContainer.find("." + y.params.paginationTotalClass).text(n)), "progress" === y.params.paginationType) {
                        var o = (r + 1) / n,
                            l = o,
                            p = 1;
                    ...
                    "custom" === y.params.paginationType && y.params.paginationCustomRender && (y.paginationContainer.html(y.params.paginationCustomRender(y, r + 1, n)), y.emit("onPaginationRendered", y, y.paginationContainer[0]))
                }
                ...
                var a = e ? "off" : "on",
                    ...
                    n = !!y.params.nested;
                if (y.browser.ie) i[t](y.touchEvents.start, y.onTouchStart, !1), r[t](y.touchEvents.move, y.onTouchMove, n), r[t](y.touchEvents.end, y.onTouchEnd, !1);
                else {
                    if (y.support.touch) {
                        ...
                        i[t](y.touchEvents.start, y.onTouchStart, o), i[t](y.touchEvents.move, y.onTouchMove, n), i[t](y.touchEvents.end, y.onTouchEnd, o)
                    }(s.simulateTouch && !y.device.ios && !y.device.android || s.simulateTouch && !y.support.touch && y.device.ios) && (i[t]("mousedown", y.onTouchStart, !1), document[t]("mousemove", y.onTouchMove, n), document[t]("mouseup", y.onTouchEnd, !1))
                }
                ...
                if (y.clickedSlide = t, y.clickedIndex = e(t).index(), y.params.slideToClickedSlide && void 0 !== y.clickedIndex && y.clickedIndex !== y.activeIndex) {
                    ...
                    if (y.params.loop) {
                        ...
                        r = parseInt(e(y.clickedSlide).attr("data-swiper-slide-index"), 10), y.params.centeredSlides ? o < y.loopedSlides - l / 2 || o > y.slides.length - y.loopedSlides + l / 2 ? (y.fixLoop(), o = y.wrapper.children("." + y.params.slideClass + '[data-swiper-slide-index="' + r + '"]:not(.' + y.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function() {
                            y.slideTo(o)
                        }, 0)) : y.slideTo(o) : o > y.slides.length - l ? (y.fixLoop(), o = y.wrapper.children("." + y.params.slideClass + '[data-swiper-slide-index="' + r + '"]:not(.' + y.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function() {
                            y.slideTo(o)
                        }, 0)) : y.slideTo(o)
                    } else y.slideTo(o)
                }
            };
            var b, C, S, z, M, I, P, E, k, D, L = "input, select, textarea, button, video",
                B = Date.now(),
                H = [];
            ...
            y.onTouchStart = function(a) {
                if (a.originalEvent && (a = a.originalEvent), (A = "touchstart" === a.type) || !("which" in a) || 3 !== a.which) {
                    ...
                    if (!y.params.swipeHandler || n(a, y.params.swipeHandler)) {
                        ...
                        if (!(y.device.ios && y.params.iOSEdgeSwipeDetection && t <= y.params.iOSEdgeSwipeThreshold)) {
                            if (b = !0, C = !1, S = !0, M = void 0, G = void 0, y.touches.startX = t, y.touches.startY = s, z = Date.now(), y.allowClick = !0, y.updateContainerSize(), y.swipeDirection = void 0, y.params.threshold > 0 && (E = !1), "touchstart" !== a.type) {
                                var i = !0;
                ...
                if (a.originalEvent && (a = a.originalEvent), !A || "mousemove" !== a.type) {
                    ...
                    if (A && y.params.touchReleaseOnEdges && !y.params.loop)
                        if (y.isHorizontal()) {
                    ...
                    if (A && document.activeElement && a.target === document.activeElement && e(a.target).is(L)) return C = !0, void(y.allowClick = !1);
                    if (S && y.emit("onTouchMove", y, a), !(a.targetTouches && a.targetTouches.length > 1)) {
                        ...
                        if (M && y.emit("onTouchMoveOpposite", y, a), void 0 === G && (y.touches.currentX === y.touches.startX && y.touches.currentY === y.touches.startY || (G = !0)), b) {
                            if (M) return void(b = !1);
                            if (G) {
                                y.allowClick = !1, y.emit("onSliderMove", y, a), a.preventDefault(), y.params.touchMoveStopPropagation && !y.params.nested && a.stopPropagation(), C || (s.loop && y.fixLoop(), P = y.getWrapperTranslate(), y.setWrapperTransition(0), y.animating && y.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), y.params.autoplay && y.autoplaying && (y.params.autoplayDisableOnInteraction ? y.stopAutoplay() : y.pauseAutoplay()), D = !1, !y.params.grabCursor || !0 !== y.params.allowSwipeToNext && !0 !== y.params.allowSwipeToPrev || y.setGrabCursor(!0)), C = !0;
                                var i = y.touches.diff = y.isHorizontal() ? y.touches.currentX - y.touches.startX : y.touches.currentY - y.touches.startY;
                                i *= y.params.touchRatio, y.rtl && (i = -i), y.swipeDirection = i > 0 ? "prev" : "next", I = i + P;
                                var r = !0;
                                if (i > 0 && I > y.minTranslate() ? (r = !1, y.params.resistance && (I = y.minTranslate() - 1 + Math.pow(-y.minTranslate() + P + i, y.params.resistanceRatio))) : i < 0 && I < y.maxTranslate() && (r = !1, y.params.resistance && (I = y.maxTranslate() + 1 - Math.pow(y.maxTranslate() - P - i, y.params.resistanceRatio))), r && (a.preventedByNestedSwiper = !0), !y.params.allowSwipeToNext && "next" === y.swipeDirection && I < P && (I = P), !y.params.allowSwipeToPrev && "prev" === y.swipeDirection && I > P && (I = P), y.params.threshold > 0) {
                                    if (!(Math.abs(i) > y.params.threshold || E)) return void(I = P);
                                    if (!E) return E = !0, y.touches.startX = y.touches.currentX, y.touches.startY = y.touches.currentY, I = P, void(y.touches.diff = y.isHorizontal() ? y.touches.currentX - y.touches.startX : y.touches.currentY - y.touches.startY)
                                }
                                ...
                                })), y.updateProgress(I), y.setWrapperTranslate(I))
                            }
                        }
                    }
                }
                ...
                if (a.originalEvent && (a = a.originalEvent), S && y.emit("onTouchEnd", y, a), S = !1, b) {
                    ...
                    if (y.allowClick && (y.updateClickedSlide(a), y.emit("onTap", y, a), s < 300 && t - B > 300 && (k && clearTimeout(k), k = setTimeout(function() {
                            ...
                            y && (y.allowClick = !0)
                        }, 0), !b || !C || !y.swipeDirection || 0 === y.touches.diff || I === P) return void(b = C = !1);
                    b = C = !1;
                    var i;
                    if (i = y.params.followFinger ? y.rtl ? y.translate : -y.translate : -I, y.params.freeMode) {
                        ...
                        if (y.params.freeModeMomentum) {
                            ...
                            if (c < y.maxTranslate()) y.params.freeModeMomentumBounce ? (c + y.maxTranslate() < -h && (c = y.maxTranslate() - h), u = y.maxTranslate(), m = !0, D = !0) : c = y.maxTranslate();
                            else if (c > y.minTranslate()) y.params.freeModeMomentumBounce ? (c - y.minTranslate() > h && (c = y.minTranslate() + h), u = y.minTranslate(), m = !0, D = !0) : c = y.minTranslate();
                            ...
                            if (0 !== y.velocity) p = y.rtl ? Math.abs((-c - y.translate) / y.velocity) : Math.abs((c - y.translate) / y.velocity);
                            else if (y.params.freeModeSticky) return void y.slideReset();
                            y.params.freeModeMomentumBounce && m ? (y.updateProgress(u), y.setWrapperTransition(p), y.setWrapperTranslate(c), y.onTransitionStart(), y.animating = !0, y.wrapper.transitionEnd(function() {
                    ...
                    for (f = 0; f < y.slidesGrid.length; f += y.params.slidesPerGroup) void 0 !== y.slidesGrid[f + y.params.slidesPerGroup] ? i >= y.slidesGrid[f] && i < y.slidesGrid[f + y.params.slidesPerGroup] && (w = f, x = y.slidesGrid[f + y.params.slidesPerGroup] - y.slidesGrid[f]) : i >= y.slidesGrid[f] && (w = f, x = y.slidesGrid[y.slidesGrid.length - 1] - y.slidesGrid[y.slidesGrid.length - 2]);
                    var T = (i - y.slidesGrid[w]) / x;
                ...
                if (y.params.autoplay && y.autoplaying && (s || !y.params.autoplayDisableOnInteraction ? y.pauseAutoplay(a) : y.stopAutoplay()), y.updateProgress(i), y.params.normalizeSlideIndex)
                ...
                var s = 0,
                    r = 0;
                y.isHorizontal() ? s = y.rtl ? -e : e : r = e, y.params.roundLengths && (s = i(s), r = i(r)), y.params.virtualTranslate || (y.support.transforms3d ? y.wrapper.transform("translate3d(" + s + "px, " + r + "px, 0px)") : y.wrapper.transform("translate(" + s + "px, " + r + "px)")), y.translate = y.isHorizontal() ? s : r;
                var n, o = y.maxTranslate() - y.minTranslate();
                n = 0 === o ? 0 : (e - y.minTranslate()) / o, n !== y.progress && y.updateProgress(e), a && y.updateActiveIndex(), "slide" !== y.params.effect && y.effects[y.params.effect] && y.effects[y.params.effect].setTranslate(y.translate), y.params.parallax && y.parallax && y.parallax.setTranslate(y.translate), y.params.scrollbar && y.scrollbar && y.scrollbar.setTranslate(y.translate), y.params.control && y.controller && y.controller.setTranslate(y.translate, t), y.emit("onSetTranslate", y, y.translate)
            }, y.getTranslate = function(e, a) {
                var t, s, i, r;
                return void 0 === a && (a = "x"), y.params.virtualTranslate ? y.rtl ? -y.translate : y.translate : (i = window.getComputedStyle(e, null), window.WebKitCSSMatrix ? (s = i.transform || i.webkitTransform, s.split(",").length > 6 && (s = s.split(", ").map(function(e) {
                    return e.replace(",", ".")
                ...
                for (a.each(function(t, r) {
                    var n = e(this);
                    t < y.loopedSlides && i.push(r), t < a.length && t >= a.length - y.loopedSlides && s.push(r), n.attr("data-swiper-slide-index", t)
                }), t = 0; t < i.length; t++) y.wrapper.append(e(i[t].cloneNode(!0)).addClass(y.params.slideDuplicateClass));
                    ...
                    setTranslate: function() {
                        for (var a = 0; a < y.slides.length; a++) {
                            ...
                            if (y.isHorizontal() ? y.rtl && (n = -n) : (p = l, l = 0, o = -n, n = 0), t[0].style.zIndex = -Math.abs(Math.round(s)) + y.slides.length, y.params.flip.slideShadows) {
                                ...
                                0 === d.length && (d = e('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "left" : "top") + '"></div>'), t.append(d)), 0 === c.length && (c = e('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>'), t.append(c)), d.length && (d[0].style.opacity = Math.max(-s, 0)), c.length && (c[0].style.opacity = Math.max(s, 0))
                            }
                ...
                cube: {
                    setTranslate: function() {
                        var a, t = 0;
                        y.params.cube.shadow && (y.isHorizontal() ? (a = y.wrapper.find(".swiper-cube-shadow"), 0 === a.length && (a = e('<div class="swiper-cube-shadow"></div>'), y.wrapper.append(a)), a.css({
                            height: y.width + "px"
                        })) : (a = y.container.find(".swiper-cube-shadow"), 0 === a.length && (a = e('<div class="swiper-cube-shadow"></div>'), y.container.append(a))));
                        for (var s = 0; s < y.slides.length; s++) {
                            ...
                            var c = "rotateX(" + (y.isHorizontal() ? 0 : -r) + "deg) rotateY(" + (y.isHorizontal() ? r : 0) + "deg) translate3d(" + l + "px, " + p + "px, " + d + "px)";
                            if (o <= 1 && o > -1 && (t = 90 * s + 90 * o, y.rtl && (t = 90 * -s - 90 * o)), i.transform(c), y.params.cube.slideShadows) {
                                var u = y.isHorizontal() ? i.find(".swiper-slide-shadow-left") : i.find(".swiper-slide-shadow-top"),
                                    m = y.isHorizontal() ? i.find(".swiper-slide-shadow-right") : i.find(".swiper-slide-shadow-bottom");
                                0 === u.length && (u = e('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "left" : "top") + '"></div>'), i.append(u)), 0 === m.length && (m = e('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>'), i.append(m)), u.length && (u[0].style.opacity = Math.max(-o, 0)), m.length && (m[0].style.opacity = Math.max(o, 0))
                            }
                        }
                        if (y.wrapper.css({
                ...
                coverflow: {
                    setTranslate: function() {
                        for (var a = y.translate, t = y.isHorizontal() ? -a + y.width / 2 : -a + y.height / 2, s = y.isHorizontal() ? y.params.coverflow.rotate : -y.params.coverflow.rotate, i = y.params.coverflow.depth, r = 0, n = y.slides.length; r < n; r++) {
                            var o = y.slides.eq(r),
                                l = y.slidesSizesGrid[r],
                                p = o[0].swiperSlideOffset,
                                d = (t - p - l / 2) / l * y.params.coverflow.modifier,
                                c = y.isHorizontal() ? s * d : 0,
                                u = y.isHorizontal() ? 0 : s * d,
                                m = -i * Math.abs(d),
                            ...
                            var v = "translate3d(" + g + "px," + h + "px," + m + "px)  rotateX(" + u + "deg) rotateY(" + c + "deg)";
                            if (o.transform(v), o[0].style.zIndex = 1 - Math.abs(Math.round(d)), y.params.coverflow.slideShadows) {
                                var f = y.isHorizontal() ? o.find(".swiper-slide-shadow-left") : o.find(".swiper-slide-shadow-top"),
                                    w = y.isHorizontal() ? o.find(".swiper-slide-shadow-right") : o.find(".swiper-slide-shadow-bottom");
                                0 === f.length && (f = e('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "left" : "top") + '"></div>'), o.append(f)), 0 === w.length && (w = e('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>'), o.append(w)), f.length && (f[0].style.opacity = d > 0 ? d : 0), w.length && (w[0].style.opacity = -d > 0 ? -d : 0)
                            }
                        }
                ...
                loadImageInSlide: function(a, t) {
                    if (void 0 !== a && (void 0 === t && (t = !0), 0 !== y.slides.length)) {
                        var s = y.slides.eq(a),
                            i = s.find("." + y.params.lazyLoadingClass + ":not(." + y.params.lazyStatusLoadedClass + "):not(." + y.params.lazyStatusLoadingClass + ")");
                        !s.hasClass(y.params.lazyLoadingClass) || s.hasClass(y.params.lazyStatusLoadedClass) || s.hasClass(y.params.lazyStatusLoadingClass) || (i = i.add(s[0])), 0 !== i.length && i.each(function() {
                            var a = e(this);
                            ...
                            var i = a.attr("data-background"),
                                ...
                                o = a.attr("data-sizes");
                            y.loadImage(a[0], r || i, n, o, !1, function() {
                                if (void 0 !== y && null !== y && y) {
                                    if (i ? (a.css("background-image", 'url("' + i + '")'), a.removeAttr("data-background")) : (n && (a.attr("srcset", n), a.removeAttr("data-srcset")), o && (a.attr("sizes", o), a.removeAttr("data-sizes")), r && (a.attr("src", r), a.removeAttr("data-src"))), a.addClass(y.params.lazyStatusLoadedClass).removeClass(y.params.lazyStatusLoadingClass), s.find("." + y.params.lazyPreloaderClass + ", ." + y.params.preloaderClass).remove(), y.params.loop && t) {
                    ...
                    if (y.params.lazyLoadingInPrevNext)
                        if (t > 1 || y.params.lazyLoadingInPrevNextAmount && y.params.lazyLoadingInPrevNextAmount > 1) {
                            var s = y.params.lazyLoadingInPrevNextAmount,
                                i = t,
                                r = Math.min(y.activeIndex + i + Math.max(s, i), y.slides.length),
                                n = Math.max(y.activeIndex - Math.max(i, s), 0);
                            for (a = y.activeIndex + t; a < r; a++) y.slides[a] && y.lazy.loadImageInSlide(a);
                ...
                setDragPosition: function(e) {
                    ...
                    s < i ? s = i : s > r && (s = r), s = -s / a.moveDivider, y.updateProgress(s), y.setWrapperTranslate(s, !0)
                },
                    ...
                    if (y.params.hashnav && !y.params.history) {
                        ...
                        if (e)
                            for (var a = 0, t = y.slides.length; a < t; a++) {
                                ...
                                if (i === e && !s.hasClass(y.params.slideDuplicateClass)) {
                                    var r = s.index();
                ...
                scrollToSlide: function(e, a, t) {
                    if (a)
                        for (var s = 0, i = y.slides.length; s < i; s++) {
                            var r = y.slides.eq(s),
                                n = this.slugify(r.attr("data-history"));
                            if (n === a && !r.hasClass(y.params.slideDuplicateClass)) {
                                var o = r.index();
                                y.slideTo(o, e, t)
                            }
                ...
                onGestureStart: function(a) {
                    ...
                    if (!(t.gesture.slide && t.gesture.slide.length || (t.gesture.slide = e(this), 0 === t.gesture.slide.length && (t.gesture.slide = y.slides.eq(y.activeIndex)), t.gesture.image = t.gesture.slide.find("img, svg, canvas"), t.gesture.imageWrap = t.gesture.image.parent("." + y.params.zoomContainerClass), t.gesture.zoomMax = t.gesture.imageWrap.attr("data-swiper-zoom") || y.params.zoomMax, 0 !== t.gesture.imageWrap.length))) return void(t.gesture.image = void 0);
                ...
                toggleZoom: function(a, t) {
                    ...
                    if (s.gesture.slide || (s.gesture.slide = a.clickedSlide ? e(a.clickedSlide) : a.slides.eq(a.activeIndex), s.gesture.image = s.gesture.slide.find("img, svg, canvas"), s.gesture.imageWrap = s.gesture.image.parent("." + a.params.zoomContainerClass)), s.gesture.image && 0 !== s.gesture.image.length) {
                        var i, r, n, o, l, p, d, c, u, m, h, g, v, f, w, x, y, T;
                        void 0 === s.image.touchesStart.x && t ? (i = "touchend" === t.type ? t.changedTouches[0].pageX : t.pageX, r = "touchend" === t.type ? t.changedTouches[0].pageY : t.pageY) : (i = s.image.touchesStart.x, r = s.image.touchesStart.y), s.scale && 1 !== s.scale ? (s.scale = s.currentScale = 1, s.gesture.imageWrap.transition(300).transform("translate3d(0,0,0)"), s.gesture.image.transition(300).transform("translate3d(0,0,0) scale(1)"), s.gesture.slide = void 0) : (s.scale = s.currentScale = s.gesture.imageWrap.attr("data-swiper-zoom") || a.params.zoomMax, t ? (y = s.gesture.slide[0].offsetWidth, T = s.gesture.slide[0].offsetHeight, n = s.gesture.slide.offset().left, o = s.gesture.slide.offset().top, l = n + y / 2 - i, p = o + T / 2 - r, u = s.gesture.image[0].offsetWidth, m = s.gesture.image[0].offsetHeight, h = u * s.scale, g = m * s.scale, v = Math.min(y / 2 - h / 2, 0), f = Math.min(T / 2 - g / 2, 0), w = -v, x = -f, d = l * s.scale, c = p * s.scale, d < v && (d = v), d > w && (d = w), c < f && (c = f), c > x && (c = x)) : (d = 0, c = 0), s.gesture.imageWrap.transition(300).transform("translate3d(" + d + "px, " + c + "px,0)"), s.gesture.image.transition(300).transform("translate3d(0,0,0) scale(" + s.scale + ")"))
                    }
                },
                attachEvents: function(a) {
                    var t = a ? "off" : "on";
    ...
    function e(e, t) {
        (a || t).container.find("[data-role=slide-refer]").each(function() {
            $(this).index() === e ? this.classList.add("_active") : this.classList.remove("_active")
        })
    }
    var a = new Swiper(".hero-slider-container", {
            containerModifierClass: "hero-slider-container-",
            ...
            slideDuplicateClass: "hero-slide--duplicate",
            slideDuplicateActiveClass: "hero-slide--duplicate-active",
            slideDuplicateNextClass: "hero-slide--duplicate-next",
            slideDuplicatePrevClass: "hero-slide--duplicate-prev",
            pagination: ".hero-slider-bullets",
            bulletClass: "hero-slider-bullet",
            bulletActiveClass: "hero-slider-bullet--active",
            paginationClickable: !0,
            nextButton: ".hero-slider-btn.hero-slider-btn--next",
            prevButton: ".hero-slider-btn.hero-slider-btn--prev",
            buttonDisabledClass: ".hero-slider-btn--disabled",
            loop: !0,
            speed: 750,
            autoplay: 7500,
            effect: "fade",
            simulateTouch: !1,
            onInit: function(a) {
                $(".hero-slider-pager__total").text(a.bullets.length < 10 ? "0" + a.bullets.length : a.bullets.length), a.container.find("[data-role=slide-refer]").on("click", function(t) {
                    t.preventDefault();
                    var s = $(this).index();
                    a.slideTo(s + 1), e(s, a)
                }), $(".home-hero").addClass("ready")
            },
            onSlideChangeStart: function(a) {
                var t = a.activeIndex <= 0 ? a.bullets.length : a.activeIndex > a.bullets.length ? 1 : a.activeIndex;
                $(".hero-slider-pager__current").text(t < 10 ? "0" + t : t), e(t - 1, a)
            },
        ...
        t = new Swiper(".home-news", {
            containerModifierClass: "home-news-",
            wrapperClass: "home-news-items",
            slideClass: "home-news-item",
            slideNextClass: "home-news-item--next",
            slidePrevClass: "home-news-item--prev",
            slideActiveClass: "home-news-item--active",
            slideDuplicateClass: "home-news-item--duplicate",
            slidesPerView: "auto",
            freeMode: !0,
            freeModeSticky: !0,
    ...
    data: function() {
        return {
            hcData: hcData,
            hcCurrentIdx: 0,
            hcTL: new TimelineMax({
                paused: !0
            }),
            hcNavTL: new TimelineMax({
                paused: !0
            }),
            hcbgTL: new TimelineMax({
                paused: !0
            }),
            hcSpeed: .75,
            hcAnimating: !1,
            direction: "next",
            hcNextbg: hcData[0].bg
        }
    },
    methods: {
        cacheImgs: function(e) {
            if (e) {
                this.cacheImgs.list || (this.cacheImgs.list = []);
                for (var a = this.cacheImgs.list, t = 0; t < e.length; t++) {
                    var s = new Image;
                    s.onload = function() {
        ...
        hcPrev: function() {
            this.direction = "prev", this.hcUpdate(this.hcCurrentIdx > 0 ? this.hcCurrentIdx - 1 : this.hcTotal)
        },
        hcNext: function() {
            this.direction = "next", this.hcUpdate(this.hcCurrentIdx < this.hcTotal ? this.hcCurrentIdx + 1 : 0)
        },
        hcUpdate: function(e) {
            var a = document.querySelectorAll(".hc-nav-item--prev"),
                t = document.querySelectorAll(".hc-nav-item--next"),
                s = document.querySelectorAll(".hc-nav-item--prev .hc-nav-item__title"),
                i = document.querySelectorAll(".hc-nav-item--next .hc-nav-item__title"),
                r = document.querySelectorAll(".hc-car"),
                n = "next" === this.direction ? "-100%" : "100%",
                o = "next" === this.direction ? "100%" : "-100%",
                l = "0%",
                p = document.querySelectorAll(".hc-bg.hc-bg--next"),
                d = document.querySelectorAll(".hc-title-clip > *"),
                c = document.querySelectorAll(".hc-go-conf"),
                u = document.querySelectorAll(".hc-badge");
            this.hcAnimating = !0, this.hcNextbg = (this.direction, this.hcData[e].bg), this.hcbgTL.fromTo(p, this.hcSpeed, {
                opacity: 0,
                ease: Power3.easeInOut
            }, {
                opacity: 1,
                ease: Power3.easeInOut
            }), this.hcTL.fromTo([r, d, c], this.hcSpeed, {
                x: "0%",
                ease: Power3.easeInOut
            }, {
                x: n,
                ...
                callbackScope: this,
                onComplete: function() {
                    this.hcCurrentIdx = e, this.hcAnimating = !1
                }
            }).set([r, d, c], {
                x: o
            }).call(function() {
                this.hcCurrentIdx = e
            }).to([r, d, c], this.hcSpeed, {
                x: "0%",
                ease: Power3.easeInOut
            }), this.hcNavTL.restart(), this.hcNavTL.to(a, this.hcSpeed, {
                alpha: 0,
                ease: Power3.easeInOut
            }, 0).to(s, .75 * this.hcSpeed, {
                alpha: 0,
                ease: Power3.easeInOut
            }, 0).to(i, .75 * this.hcSpeed, {
                alpha: 0,
                ease: Power3.easeInOut
            }, 0).to(u, this.hcSpeed / 2, {
                scale: 0,
            ...
            }, 0), this.hcbgTL.play(), this.hcTL.play(), this.hcNavTL.play(), this.cacheImgs(this.hcCacheArray)
        }
    },
    computed: {
        hcTotal: function() {
        ...
        hcCacheArray: function() {
            var e = [this.hcData[this.hcPrevIdx].bg, this.hcData[this.hcNextIdx].bg];
            return [this.hcData[this.hcPrevIdx > 0 ? this.hcPrevIdx - 1 : this.hcTotal].picture, this.hcData[this.hcNextIdx < this.hcTotal ? this.hcNextIdx + 1 : 0].picture].concat(e)
        }
    },
    filters: {
    ...
    methods: {
        openVideoModal: function(e) {
            this.videoId = e.currentTarget.getAttribute("data-video"), this.videoModal.show()
        }
    },
    mounted: function() {
        function e() {
            var e = Math.abs(this.y / i);
            r.progress(e), n.progress(e)
        }
        var a = document.getElementById("home-tech__curve"),
            t = document.getElementById("home-tech__thumb"),
            s = (a.scrollHeight - t.clientHeight + 50) / 2,
            i = .75 * a.clientHeight,
            r = new TimelineMax({
                paused: !0
            }),
        ...
        r.to(t, 1, {
        ...
        }, 0), n.set(".home-tech__ci", {
            x: "-50%",
            y: "-50%"
        }).from(".home-tech__pin--1 .home-tech__ci", 10, {
            scale: 1,
            opacity: 1,
            delay: 0,
            ease: Power1.easeInOut
        }, 0).from(".home-tech__pin--2 .home-tech__ci", 5, {
            scale: 1,
            opacity: 1,
            delay: 0,
            ease: Power1.easeInOut
        }, 0).to(".home-tech__pin--3 .home-tech__ci", 5, {
            scale: 1,
            opacity: 1,
            delay: 10,
            ease: Power1.easeInOut
        }, 0).to(".home-tech__pin--4 .home-tech__ci", 10, {
            scale: 1,
            opacity: 1,
            delay: 10,
            ease: Power1.easeInOut
        }, 0), l = Draggable.create(o, {
            trigger: t,
            type: "y",
            bounds: {
                minY: 0,
            ...
            y: i / 2
        }), l.update(), r.progress(.5), n.progress(.5);
        var p = this;
        this.videoModal = new Spreader("#tech-video-template", {
            onShow: function() {
                var e = "https://www.youtube.com/embed/" + p.videoId + "?rel=0&amp;showinfo=0;autoplay=1;controls=0";
                this.$content.find(".tech-video-modal__frame").attr("src", e)
            },
            onClose: function() {
                this.$content.find(".tech-video-modal__frame").attr("src", "")
            }
        })
    }
}), window.homeVM.$mount('[data-model="home"]');