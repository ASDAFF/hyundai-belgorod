...
<div class="cont">
    <div class="banner nblock">
        ...
        <a href="javascript:void(0)" class="banner-evaluation zing_form_toggler" for="zing_cuzov_btn">
...
<!--                            <a href="/dealers-h-promise/" class="slider-inner-text-single-go-inner">Найти дилера</a>-->
    ...
    <div class="carslider nblock">
        ...
        <div class="carslider-inner">
            ...
            <div class="carslider-inner-single">
                ...
                <a href="/configurator/" class="carslider-inner-single-button buttonkonf">
            ...
            <div class="carslider-inner-single">
                ...
                <div class="carslider-inner-single-img">
                    <img src="https://hpromise.hyundai.ru/upload/iblock/54e/platinum-silver_12.png">
                </div>
                <a href="/test-drive/" class="carslider-inner-single-button buttontd">
                    <span>Тест-драйв</span>
                </a>
    ...
    <div class="nblock">
        <div class="footnote">
            ...
            <p>Подробности у официальных <a href="https://hpromise.hyundai.ru/dealers-h-promise/">дилеров H-Promise</a>.</p>
        </div>
    </div>
</div>
    ...
    <form class="zing_form" action="#" for="testdrive">
        <div class="zing_form_content">
            ...
            <div class="zing-input">
                <input
                    type		= "text"
                    class		= "zing_last_name mark zing_txt"
                    name		= "zing_last_name"
                    id			= "zing_last_name"
                    maxlength	= "50">
                <label for="zing_first_name"></label>
            </div>
...
<script>
    $(function(){
        $('.zing_form_toggler_spec').click(function(){
            $('.zing_last_name.mark').val($(this).parent().find('.carslider-inner-single-title').text());
        });
    });
</script>
