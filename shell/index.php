									...
									<svg tabindex="-1" aria-visible="false" class="ic-svg"><use xlink:href="#ic-dropdown-corner"></use></svg>
                                        ...
                                        <div class="list-component-holder">
                                            <ul class="list">
                                                ...
                                                <li value="4" data-img="i40" class="list-item">i40</li>
                                                <li value="5" data-img="tucson" class="list-item">TUCSON</li>
                                                <li value="6" data-img="grandsantafe" class="list-item">GRAND SANTA FE</li>
                                                <li value="7" data-img="santafe" class="list-item">SANTA FE</li>
                                                <li value="8" data-img="creta" class="list-item">Creta</li>
                                                <li value="9" data-img="sonatanew" class="list-item">Sonata New</li>
                                                <li value="10" data-img="ix35" class="list-item">ix35</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
