...
?>
    ...
    -->
                            ...
                            <div id="dropdown-carlisting" class="dealer__location-dropdown drop-it-down" tabindex="0">
                                ...
                                <div class="nano">
                                    <ul class="dropdown-list nano-content">
                                        <li data-model="New Elantra"			model="Новая ELANTRA"			class="dropdown-item " >Новая ELANTRA</li>
                                        <li data-model="Sonata"			model="Sonata"			class="dropdown-item " >Новая SONATA</li>
        ...
        <script>
            var i30NAllowDealers = ["C40AF01155", "C40AF00985", "C40AF01093", "C40AF00182", "C40AF01028"];
        </script>
