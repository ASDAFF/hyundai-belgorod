...
?>
    ...
    <link rel="stylesheet" type="text/css" href="/media/css_new/pip_flat_SF.css"/>
    ...
    <script type="text/javascript" src="/media/js_new/pip_flat_SF.js"></script>
    <script type="text/javascript" src="/media/js_new/pip_flat_SL_com_jspPane.js"></script>

    <style>
        /* parallax bg */
        .parallax0 {background:url('/media/images/flat/SF/elements/parallax_1.jpg') no-repeat fixed 50% 50% #fff;}/* dec 29 15 */
        .parallax1 {background:url('/media/images/flat/SF/elements/parallax_2.jpg') no-repeat fixed 50% 50% #fff;}/* 2015-07-31 */
        .parallax2 {background:url('/media/images/flat/SF/elements/parallax_3.jpg') no-repeat fixed 50% 50% #fff;}
        .parallax3 {background:url('/media/images/flat/SF/elements/parallax_4.jpg') no-repeat fixed 50% 50% #fff;}
        .parallax4 {background:url('/media/images/flat/SF/elements/parallax_5.jpg') no-repeat fixed 50% 50% #fff;}
        .parallax5 {background:url('/media/images/flat/SF/elements/parallax_6.jpg') no-repeat fixed 50% 50% #fff;}

        body.mobile .parallax { height:450px;}
        body.mobile .parallax1 {background:url('/media/images/flat/SF/elements/parallax_1.jpg') center top no-repeat #e3e3e3;}/* dec 29 15 */
        body.mobile .parallax1 {background:url('/media/images/flat/SF/elements/parallax_2.jpg') center top no-repeat #e3e3e3;}/* 2015-07-31 */
        body.mobile .parallax2 {background:url('/media/images/flat/SF/elements/parallax_3.jpg') center top no-repeat #fff;}
        body.mobile .parallax3 {background:url('/media/images/flat/SF/elements/parallax_4.jpg') center top no-repeat #fff;}
        body.mobile .parallax4 {background:url('/media/images/flat/SF/elements/parallax_5.jpg') center top no-repeat #fff;}
        body.mobile .parallax5 {background:url('/media/images/flat/SF/elements/parallax_6.jpg') center top no-repeat #fff;}
    </style>
    ...
    <div class="wrap" id="wrap">
        ...
        SANTA FE LANDING; BASED ON SOLARIS REDESIGN TEMPLATE
                    ...
                    <div class="items">
                        <div class="item">
                            <div class="item_wrap">
                                <div class="main mkv">
                                    <div class="title">
                                        <img src="/media/images/flat/SF/elements/logo.png" title="Santa Fe" alt="Эмблема Santa Fe">
                                    ...
                                    <div class="title-price">
                                        ...
                                        <!-- 								от 1 769 000 &#8381; -->
                                        <a href="http://www.hyundai.ru/configurator" target="_blank" class="title-price-notice">В кредит от 38 485 &#8381; / месяц</a>
                                    </div>
                                ...
                                <!-- 						<img src="/media/images/flat/SF/elements/info_car_pic.jpg" style="float: right; margin-top: 85px;"> -->
                                ...
                                <a class="view-360_toggler" href="#" style="top: 350px;"></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="top-menu" class="top-menu">
                <div class="top-menu__wrap">
                    <div class="information">
					 ...
					 --><li><a class="configurator" href="http://www.hyundai.ru/configurator" target="_blank" title="Цены комплектации">ЦЕНЫ И КОМПЛЕКТАЦИИ</a></li><!--
					 --><li class="broshure-item" title="Брошюра"><a data-gtm-havas-model="santafe" href="#" data-model="Santa Fe" for="brochures_request" class="zing_form_toggler broshure" target="_blank">БРОШЮРА</a></li><!--
					 --><li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="list">
                                        <ul>
                                            <li class="thumb1 front">
                                                <a href="#">
											<span class="img_wrap">
												<img src="/media/images/flat/SF/elements/highlights_1.jpg" data-url="/media/images/flat/SF/elements/highlights_1.jpg" alt="Элегантное исполнение" width="306" height="306" />
                                            ...
                                            <li class="thumb2 side">
                                                <a href="#">
											<span class="img_wrap">
												<img src="/media/images/flat/SF/elements/highlights_2.jpg" data-url="/media/images/flat/SF/elements/highlights_2.jpg" alt="Превосходство комфорта" width="306" height="306" />
												<span class="dimd"></span>
											</span>
                                            ...
                                            <li class="thumb3 safe">
                                                <a href="#">
											<span class="img_wrap">
												<img src="/media/images/flat/SF/elements/highlights_3.jpg" data-url="/media/images/flat/SF/elements/highlights_3.jpg" alt="Безопасность на высшем уровне" width="306" height="306" />
												<span class="dimd"></span>
											</span>
                                    ...
                                    <div class="view">
                                        <ul>
                                            <li class="thumb1 front">
                                                ...
                                                <div class="img"><img src="/media/images/flat/SF/elements/highlights_popup_1.jpg" data-url="/media/images/flat/SF/elements/highlights_popup_1.jpg" width="623" height="306" alt="Решетка радиатора"></div>
                                                <div class="txt-wrap">
                                                    <div class="txt">
                                            ...
                                            <li class="thumb2 side">
                                                <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                <div class="img"><img src="/media/images/flat/SF/elements/highlights_popup_2.jpg" data-url="/media/images/flat/SF/elements/highlights_popup_3.jpg" width="623" height="306" alt="Обивка салона"></div>
                                                <div class="txt-wrap">
                                                    <div class="txt">
                                            ...
                                            <li class="thumb3 safe">
                                                <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                <div class="img"><img src="/media/images/flat/SF/elements/highlights_popup_3.jpg" data-url="/media/images/flat/SF/elements/highlights_popup_3.jpg" width="623" height="306" alt="Колесные диски"></div>
                                                <div class="txt-wrap">
                                                    <div class="txt">
                        ...
                        <div class="main_wrap">
                            <div class="highlight_twin clearfix">
                                <div class="left">
                                    ...
                                    <div class="image">
                                        <img src="/media/images/flat/SF/elements/highlights_4.jpg" width="306" height="306" alt="Внушительная мощность" />
                                    </div>
                                </div>
                                <div class="mid">
                                    <div class="subject">
                                    ...
                                    <div class="image">
                                        <img src="/media/images/flat/SF/elements/highlights_5.jpg" width="306" height="306" alt="Максимальный простор" />
                                    </div>
                                </div>
                                <div class="right">
                                    <div class="subject">
                                    ...
                                    <div class="image">
                                        <img src="/media/images/flat/SF/elements/highlights_6.jpg" width="306" height="306" alt="Аудиосистема премиум-класса" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pos">
                                <ul class="view">
                                    <li class="front">
                                        <div class="scene">
                                            <div class="car">
                                                <img src="/media/images/flat/SF/elements/angle_1.png" alt="Фото экстерьера Санта Фе" />
                                                <div class="plus_wrap">
                                            ...
                                            <div class="sub_wrap">
                                                <ul>
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/SF/elements/exterior_popup_2.jpg" width="470" height="470" alt="Дневные ходовые огни" /></div>
                                                        <div class="txt">
                                                    ...
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/SF/elements/exterior_popup_1.jpg" width="470" height="470" alt="Передние фары с ксеноновыми лампами" /></div>
                                                        <div class="txt">
                                                    ...
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/SF/elements/exterior_popup_3.jpg" width="470" height="470" alt="Решетка радиатора" /></div>
                                                        <div class="txt">
                                    ...
                                    <li class="side">
                                        <div class="scene">
                                            <div class="car">
                                                <img src="/media/images/flat/SF/elements/angle_2.png" alt="Вид сбоку" />
                                                <div class="plus_wrap">
                                            ...
                                            <div class="sub_wrap">
                                                <ul>
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/SF/elements/exterior_popup_6.jpg" width="470" height="470" alt="Светодиодный повторитель указателей поворота" /></div>
                                                        <div class="txt">
                                                    ...
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/SF/elements/exterior_popup_5.jpg" width="470" height="470" alt="Багажник на крыше" /></div>
                                                        <div class="txt">
                                    ...
                                    <li class="rear">
                                        <div class="scene">
                                            <div class="car">
                                                <img src="/media/images/flat/SF/elements/angle_3.png" alt="Вид багажника" />
                                                <div class="plus_wrap">
                                            ...
                                            <div class="sub_wrap">
                                                <ul>
                                                    <li>
                                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                                        <div class="img"><img src="/media/images/flat/SF/elements/exterior_popup_7.jpg" width="470" height="470" alt="Светодиодные фонари" /></div>
                                                        <div class="txt">
                            ...
                            <div class="carousel-holder">
                                <div class="carousel-slider">
                                    <div class="carousel-item morelist alive">
                                        <ul class="clearfix">
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Сдвоенные выхлопные трубы" src="/media/images/flat/SF/elements/exterior_1.jpg" /></span>
										<span class="description">
                                            ...
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Задний спойлер со светодиодами" src="/media/images/flat/SF/elements/exterior_2.jpg"/></span>
										<span class="description">
                                            ...
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Панорамная крыша с люком" src="/media/images/flat/SF/elements/exterior_3.jpg"/></span>
										<span class="description">
											<strong>Панорамная крыша с люком</strong>
											Глянцево-черная отделка вокруг окон<br>
											Santa Fe пришлась бы впору и седану<br>
											класса люкс.
							            </span>
                                            </li>
                                        </ul>
                            ...
                            <div class="scene_wrap">
                                <div class="scene_offset">
                                    <div class="offset2">
                                        <div class="scene_cut">
                                            <div class="scene1">
                                                <div class="img">
                                                    <img src="/media/images/flat/SF/elements/view_1.jpg" width="1050" height="540" alt="Фото интерьера салона Санта Фе" />
                                                    <div class="plus_wrap">
                                            ...
                                            <div class="scene2">
                                                <div class="img">
                                                    <img src="/media/images/flat/SF/elements/view_2.jpg" width="1050" height="540" alt="Фото интерьера салона Санта Фе" />
                                                    <div class="plus_wrap">
                                ...
                                <div class="details">
                                    <div class="pop_11">
                                        ...
                                        <img src="/media/images/flat/SF/elements/interior_popup_1.jpg" width="525" height="540" alt="Полностью автоматический кондиционер" />
                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                    </div>
                                    <div class="pop_12">
                                        <div class="details_txt">
                                            <strong>Функциональный подлокотник</strong>
                                            <p>Функциональный подлокотник имеет щедрый ящик для хранения для всего, от монет до безделушек.</p>
                                        </div>
                                        <img src="/media/images/flat/SF/elements/interior_popup_2.jpg" width="525" height="540" alt="Напольная консоль" />
                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                    </div>
                                    <div class="pop_13">
                                        <div class="details_txt">
                                        ...
                                        <img src="/media/images/flat/SF/elements/interior_popup_1.jpg" width="525" height="540" alt="Багажное отделение Santa Fe" />
                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                    </div>
                                    <div class="pop_14">
                                        <div class="details_txt">
                                        ...
                                        <img src="/media/images/flat/SF/elements/interior_popup_2.jpg" width="525" height="540" alt="Расположение сидений" />
                                        <div class="close"><a href="#"><span>Закрыть</span></a></div>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-holder">
                                <div class="carousel-slider">
                                    <div class="carousel-item morelist alive">
                                        <ul class="clearfix">
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Крепление детского сиденья2" src="/media/images/flat/SF/elements/interior_5.jpg"/></span>
				                        <span class="description">
                                            ...
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Держатель для стаканов" src="/media/images/flat/SF/elements/interior_1.jpg"/></span>
										<span class="description">
                                            ...
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Центральная консоль" src="/media/images/flat/SF/elements/interior_2.jpg"/></span>
				                        <span class="description">
                                    ...
                                    <div class="carousel-item morelist">
                                        <ul class="clearfix">
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Передняя панель" src="/media/images/flat/SF/elements/interior_3.jpg"/></span>
				                        <span class="description">
                                            ...
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Крепление детского сиденья" src="/media/images/flat/SF/elements/interior_4.jpg"/></span>
				                        <span class="description">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <p>Усовершенствованная система впуска с изменяемой
                                        ...
                                        Theta II 2.4 MPi выдает максимальную мощность 175 л.с. при 6000 об/мин.
                                    </p>
                                    <div class="graph">
                                        <div class="pos">
                                            <img src="/media/images/flat/SF/elements/performance_graph.png" width="470" height="530" alt="График показателей двигателя Gamma 1.4" /><br>
                                            <div class="text"><img src="/media/images/flat/SF/elements/performance_graph_text.png" width="470" height="530" alt="" /></div>
                                        </div>
                                    </div>
                                    <div class="max">
                                        <dl class="max_power">
                                ...
                                <li>
                                    ...
                                    <p>Максимальная мощность дизельного двигателя 2.2 CRDi
                                        ...
                                        лучшую топливною экономичность, более высокую
                                        производительность и способствует уменьшению шумов.
                                    </p>
                                    <div class="graph">
                                        <div class="pos">
                                            <img src="/media/images/flat/SF/elements/performance_graph_2.png" class="lazy" width="470" height="530" alt="График показателей двигателя Gamma 1.6" /><br>
                                            <div class="text"><img src="/media/images/flat/SF/elements/performance_graph_2_text.png" class="lazy" width="470" height="530" alt="" /></div>
                                        </div>
                                    </div>
                                    <div class="max">
                                        <dl class="max_power">
...
<!-- 							<span class="notemark">только для двигателя 1,6 л</span> -->
                                ...
                                <div class="btm_img"><img class="lazy" width="525" height="465" alt="Автоматическая коробка переключения передач" src="/media/images/common/transparent.gif" data-original="/media/images/flat/SF/elements/performance_1.jpg" /></div>
                            </li>
                            <li>
						<span class="description">
...
<!-- 							<span class="notemark">только для двигателя 1,6 л</span> -->
                                ...
                                <div class="btm_img"><img class="lazy" width="525" height="465" alt="Механическая коробка переключения передач" src="/media/images/common/transparent.gif" data-original="/media/images/flat/SF/elements/performance_2.jpg" /></div>
                            </li>
                        </ul>
                    </div>
                </div>
                <div id="contents_safety" class="contents_safety pip">
                    ...
                    <div class="pip_cont">
						...
						крутящего момента двигателя и дорожных условий.
                            ...
                            <div class="scene">
                                <img class="car" src="/media/images/flat/SF/elements/safety_1.jpg" width="940" height="" title="" alt="Электронный контроль устойчивости (ESC)">
                            </div>
                        </div>
                        ...
                        <div class="safety_slider-wrap">
                            <ul class="safety_slider">
                                <li class="safety_slider-item alive" class="alive">
                                    <img class="lazy" alt="Система помощи при трогании на подъеме (HAC)" src="/media/images/common/transparent.gif" data-original="/media/images/flat/SF/elements/safety_slider_1.jpg" width="1920" height="540">
							...
							автомобилем во время движения со склона.
                                ...
                                <li class="safety_slider-item">
                                    <img src="/media/images/flat/SF/elements/safety_slider_2.jpg" width="1920" height="540" alt="BAS (Система помощи при торможении)">
							...
							на тормоза, обеспечивая максимально эффективное торможение.
                                ...
                                <li class="safety_slider-item">
                                    <img src="/media/images/flat/SF/elements/safety_slider_3.jpg" width="1920" height="540" alt="Высокоэффективная тормозная система">
							...
							при очень динамичном вождении.
                                ...
                                <li class="safety_slider-item">
                                    <img src="/media/images/flat/SF/elements/safety_slider_4.jpg" width="1920" height="540" alt="VSM (Система управления стабилизацией)">
                            ...
                            <ul class="safety_slider-paginator">
                                <li class="alive">
                                    <img class="lazy" alt="" src="/media/images/common/transparent.gif" data-original="/media/images/flat/SF/elements/safety_preview_1.jpg" width="90" height="90">
                                    <div class="bordered"></div>
                                </li>
                                <li>
                                    <img class="lazy" alt="" src="/media/images/common/transparent.gif" data-original="/media/images/flat/SF/elements/safety_preview_2.jpg" width="90" height="90">
                                    <div class="bordered"></div>
                                </li>
                                <li>
                                    <img class="lazy" alt="" src="/media/images/common/transparent.gif" data-original="/media/images/flat/SF/elements/safety_preview_3.jpg" width="90" height="90">
                                    <!-- 							<div class="bordered-ghost"></div> -->
                                    <div class="bordered"></div>
                                </li>
                                <li>
                                    <img class="lazy" alt="" src="/media/images/common/transparent.gif" data-original="/media/images/flat/SF/elements/safety_preview_4.jpg" width="90" height="90">
                                    <div class="bordered"></div>
                                </li>
                            </ul>
                            ...
                            <ul class="list_wrap">
                                <li class="list list1">
                                    <a href="#">
                                        ...
                                        <img src="/media/images/flat/SF/elements/convenience_1.jpg" width="470" height="250" alt="Помощь при парковке" />
                                    </a>
                                </li>
                                <li class="list list2">
                                    <a href="#">
                                        <strong>Приборная панель<br>Supervision</strong>
                                        <img src="/media/images/flat/SF/elements/convenience_2.jpg" width="470" height="250" alt="Приборная панель Supervision" />
                                    </a>
                                </li>
                                <li class="list list3">
                                    <a href="#">
                                        <strong>Функциональный<br>руль</strong>
                                        <img src="/media/images/flat/SF/elements/convenience_3.jpg" width="470" height="250" alt="Функциональный руль" />
                                    </a>
                                </li>
                                <li class="list list4">
                                    <a href="#">
                                        <strong>Боковая лампа</strong>
                                        <img src="/media/images/flat/SF/elements/convenience_4.jpg" width="470" height="250" alt="Боковая лампа" />
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="convenience__slider-cut">
                                <ul class="view_wrap">
                                    <li class="view view1 alive">
                                        <img src="/media/images/flat/SF/elements/convenience_popup_1.jpg" width="940" height="500" alt="Система помощи при парковке" />
                                        <div class="text">
                                    ...
                                    <li class="view view2">
                                        <img src="/media/images/flat/SF/elements/convenience_popup_2.jpg" width="940" height="500" alt="Подсветка приборной панели" />
                                        <div class="text">
                                    ...
                                    <li class="view view3">
                                        <img src="/media/images/flat/SF/elements/convenience_popup_3.jpg" width="940" height="500" alt="Система управления на руле" />
                                        <div class="text">
                                    ...
                                    <li class="view view4">
                                        <img src="/media/images/flat/SF/elements/convenience_popup_4.jpg" width="940" height="500" alt="Автоматический климат-контроль" />
                                        <div class="text">
                                ...
                                <div class="carousel-slider">
                                    <div class="carousel-item morelist alive">
										...
										<span class="description">
                                            ...
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Бесконтактный ключ" src="/media/images/flat/SF/elements/convenience_6.jpg"/></span>
										<span class="description">
                                            ...
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Окна с безопасными стеклоподъемниками" src="/media/images/flat/SF/elements/convenience_7.jpg"/></span>
										<span class="description">
                                    ...
                                    <div class="carousel-item morelist">
                                        <ul class="clearfix">
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Обогрев лобового стекла" src="/media/images/flat/SF/elements/convenience_8.jpg"/></span>
										<span class="description">
                                            ...
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Датчик дождя" src="/media/images/flat/SF/elements/convenience_9.jpg"/></span>
										<span class="description">
                                            ...
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Автоматическая система предотвращения запотевания" src="/media/images/flat/SF/elements/convenience_10.jpg"/></span>
										<span class="description">
                                    ...
                                    <div class="carousel-item morelist">
                                        <ul class="clearfix">
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Коленная подушка безопасности водителя" src="/media/images/flat/SF/elements/convenience_11.jpg"/></span>
										<span class="description">
                                            ...
                                            <li>
                                                <span class="img"><img width="306" height="200" alt="Обогреваемые стеклоочистители" src="/media/images/flat/SF/elements/convenience_12.jpg"/></span>
										<span class="description">
            ...
            <div class="content-type content-type__specs">
                <div id="contents_specs" class="contents_specs pip">
                    ...
                    <div class="detailedSpecLink">
                        <a href="/configurator?car_id=18&compl_id=254" target="_blank">Подробные характеристики</a>
                    </div>
                ...
                <div class="content-type content-type__gallery">
                    <div id="contents_gallery" class="contents_gallery pip">
                        <div class="gallery_wrap">
                            <div class="title_wrap clearfix">
                                <h2 class="title_wrap_h2">Фото Hyundai Santa Fe</h2>
                            ...
                            <ul id="all-gallery-items">
                                <li><img data-type="exterior" width="229" height="144" alt="Фото Солярис - вид сбоку" src="/media/images/flat/SF/gallery_pics/gallery_preview_1.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_1.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="Солярис в городской среде" src="/media/images/flat/SF/gallery_pics/gallery_preview_2.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_2.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="Солярис на дороге" src="/media/images/flat/SF/gallery_pics/gallery_preview_3.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_3.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="Фото передней части Solaris" src="/media/images/flat/SF/gallery_pics/gallery_preview_4.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_4.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="Габаритные огни" src="/media/images/flat/SF/gallery_pics/gallery_preview_5.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_5.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="Система парктроника" src="/media/images/flat/SF/gallery_pics/gallery_preview_6.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_6.jpg"/></li>
                                <li><img data-type="exterior" width="229" height="144" alt="Передние противотуманные огни" src="/media/images/flat/SF/gallery_pics/gallery_preview_7.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_7.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="Вид передней панели салона" src="/media/images/flat/SF/gallery_pics/gallery_preview_8.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_8.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="Электронные стеклоподъемники" src="/media/images/flat/SF/gallery_pics/gallery_preview_9.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_9.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="Стильная рукоять переключения скоростей" src="/media/images/flat/SF/gallery_pics/gallery_preview_10.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_10.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="Механическая коробка передач Солярис" src="/media/images/flat/SF/gallery_pics/gallery_preview_11.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_11.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="Повышенный уровень безопасности" src="/media/images/flat/SF/gallery_pics/gallery_preview_12.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_12.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="Обивка салона Solaris" src="/media/images/flat/SF/gallery_pics/gallery_preview_13.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_13.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="Удобство руля и органов управления" src="/media/images/flat/SF/gallery_pics/gallery_preview_14.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_14.jpg"/></li>
                                <li><img data-type="interior" width="229" height="144" alt="Фото панели управления аудиосистемой" src="/media/images/flat/SF/gallery_pics/gallery_preview_15.jpg" data-href="/media/images/flat/SF/gallery_pics/gallery_15.jpg"/></li>
                            </ul>
            ...
            <div class="prefooter-promo">
                <div class="promo-main">
					...
					<span class="promo-text">ВВыберите ближайший дилерский центр, пройдите
					...
					кредитования и другие предложения Drive Hyundai.
                        ...
                        <img src="/media/images/flat/SF/elements/promo_pic.png" width="525" height="350" alt="Тест драйв Хендай Санта Фе">
                    </div>
