                ...
                <div class="cubebox" id="cubebox" style="height: 530px;">
                    <div class="cubelist" style="height: 530px;">
                        <div class="items" style="height: 530px;">
                            <div class="item" style="height: 530px;">
                                <div class="item_wrap">
                                    <div class="main mkv">
                                        <div class="title">
...
<!-- 							<span class="notemark">только для двигателя 1,6 л</span> -->
                ...
                <div class="disc-block"><p class="dicslamer-casco"><sup>1</sup> Полис КАСКО на безвозмездной основе оформляется на срок 1 (один) год в СПАО «Ингосстрах», ПАО «Росгосстрах» и СК «ВСК» при покупке Нового Hyundai Santa Fe в кредит по программе СТАРТ. Указанная информация носит справочный характер и не является публичной офертой. Условия и тарифы могут быть изменены СПАО «Ингосстрах», ПАО «Росгосстрах» и СК «ВСК» в одностороннем порядке. Предложение действует до 31.12.2017г.</p></div>
            </div>
        </div><!-- // container -->
