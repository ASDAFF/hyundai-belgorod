...
?>
    ...
    <main class="main" data-model="home">
        ...
        <style>
            .parallax0 {background:url('/media/images/flat/EL/elements/parallax_1.jpg') no-repeat fixed 50% 50% #fff;}
            .parallax1 {background:url('/media/images/flat/EL/elements/parallax_2.jpg') no-repeat fixed 50% 50% #fff;}
            ...
            body.mobile .parallax0 {background:url('/media/images/flat/EL/elements/parallax_1.jpg') center top no-repeat #e3e3e3;}
            body.mobile .parallax1 {background:url('/media/images/flat/EL/elements/parallax_2.jpg') center top no-repeat #e3e3e3;}
            ...
            <div class="container">
                                ...
                                <div class="item_wrap">
                                    ...
                                    <div class="view-360-color-selector">
                                        <ul>
                                            ...
                                            <li data-title="Stargazing Blue"		data-color="Stargazing_Blue"		class="view-360-color-selector__item"><span style="background-color: #3A4969;"></span>Stargazing Blue</li>
                ...
                <div id="top-menu" class="top-menu">
                    <div class="top-menu__wrap">
					 ...
					 --><li><a class="configurator" href="/configurator/car/7/modification" title="Цены комплектации">ЦЕНЫ И КОМПЛЕКТАЦИИ</a></li><!--
					 --><li class="broshure-item" title="Каталог"><a data-gtm-havas-model="elantra" href="#" data-model="Elantra" for="brochures_request" class="zing_form_toggler broshure" target="_blank">КАТАЛОГ</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-type content-type__specs">
                    <div id="contents_specs" class="contents_specs pip">
                        ...
                        <div class="detailedSpecLink">
                            <a href="/configurator/car?car_id=18#desc" onClick="ga('send', 'event', 'knopka', 'click');">Подробные характеристики</a>
                        </div>
                        <div class="spec_message">
                            <div>
                ...
                <div class="prefooter-promo">
					...
					кредитования и другие предложения Drive Hyundai.
                        ...
                        <div class="promo-grid">
                            <ul class="clearfix">
                                <li><a href="/configurator/car/7/modification"><span>Конфигуратор Elantra</span></a></li>
                                <li><a href="/configurator/car/7/modification&calc_open=1"><span>Рассчитать кредит</span></a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <script type="text/javascript" >
            ...
            _rutarget.push({'event': 'showOffer', 'sku': 'Elantra'});
        </script>
        <!--/RuTarget-->
    </main>
    ...
    <script type="text/javascript" src="https://www.hyundai.ru/media/js/cars/pip_flat_EL.js"></script>
